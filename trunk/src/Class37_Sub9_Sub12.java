...
public class Class37_Sub9_Sub12 extends Class37_Sub9 {
    ...
    public static JString aJString_3119;
    public static int anInt3120;
    public static int anInt3121 = 0;
    public static int anInt3122;
    public static JString aJString_3123;
    public static int anInt3124;

    static {
        aJString_3119 = (Class37_Sub2.method332((byte) 103,
                "Unerwartete Antwort vom Anmelde)2Server"));

        aJString_3123 = Class37_Sub2.method332((byte) 102,
...
while_63_: 
    ...
    public static void method810(int i) {
        for (int i_1_ = -1;
            ...
            Class37_Sub4_Sub7_Sub1_Sub2 class37_sub4_sub7_sub1_sub2 = Class75.aClass37_Sub4_Sub7_Sub1_Sub2Array1414[i_2_];
            ...
            if ((class37_sub4_sub7_sub1_sub2 != null) &&
                ...
                if (class37_sub4_sub7_sub1_sub2.anInt3662 == 0) {
                    class37_sub4_sub7_sub1_sub2.aJString_3694 = null;
                }
            }
        }
        ...
        for (int i_3_ = 0; i_3_ < Class76.anInt1436; i_3_++) {
            ...
            Class37_Sub4_Sub7_Sub1_Sub1 class37_sub4_sub7_sub1_sub1 = Class37_Sub13.aClass37_Sub4_Sub7_Sub1_Sub1Array2111[i_4_];
            ...
            if ((class37_sub4_sub7_sub1_sub1 != null) &&
                ...
                if ((class37_sub4_sub7_sub1_sub1.anInt3662 ^ 0xffffffff) == -1) {
                    class37_sub4_sub7_sub1_sub1.aJString_3694 = null;
                }
            }
        }
    ...
    public int[] method761(int i, int i_6_) {
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_9_ = 0; (i_9_ ^ 0xffffffff) > (anInt3112 ^ 0xffffffff);
                    i_9_++) {
                int i_10_ = (((anInt3111 ^ 0xffffffff) >= -1) ? anInt3110
                                                              : (anInt3110 -
                ...
                int i_12_ = Class20.method216(Class37_Sub14.anInt2121, random,
                        (byte) -90);
                int i_13_ = i_12_ +
                    ((Class13.anIntArray226[i_10_] * anInt3115) >> -406625268);
                int i_14_ = ((Class37_Sub4_Sub7_Sub2.anIntArray3711[i_10_] * anInt3115) >> 1899067532) +
                    i_11_;
                ...
                if ((i_16_ != 0) || ((i_15_ ^ 0xffffffff) != -1)) {
                    ...
                    int i_25_ = -i_21_ / 2;
                    int i_26_ = 1024 +
                        -(Class20.method216(4096, random, (byte) -91) >> 376903266);
                    ...
                    for (int i_28_ = i_11_;
                        ...
                        int i_30_ = Class37_Sub4_Sub7_Sub1_Sub2.anInt3989 &
                            i_22_;
