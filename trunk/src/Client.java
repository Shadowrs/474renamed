...
public class Client extends Applet_Sub1 {
    ...
    public static JString aJString_1721;
    public static JString aJString_1722 = Class37_Sub2.method332((byte) 112,
            "cross");
    public static int anInt1723;
    public static int anInt1724;
    public static int anInt1725;
    public static int anInt1726;
    public static JString aJString_1727;
    ...
    static {
        anInt1719 = 0;
        aJString_1721 = Class37_Sub2.method332((byte) 115, "nav");
        aJString_1727 = Class37_Sub2.method332((byte) 124, ")3");
    ...
    public void method18(byte i) {
        ...
        if ((Class37_Sub9_Sub36.anInt3579 ^ 0xffffffff) != -2) {
            ...
            ItemDef.aShortArray2491 = Class84.aShortArray1524;
            Login.aShortArray789 = Class37_Sub4_Sub5.aShortArray2603;
        } else {
            Class37_Sub4_Sub7_Sub1.aShortArrayArray3702 = Class37_Sub2.aShortArrayArray1822;

            ItemDef.aShortArray2491 = Class37_Sub9_Sub8.aShortArray3048;

            Class37_Sub17.aShortArrayArray2159 = Class37_Sub25.aShortArrayArray2280;
            Login.aShortArray789 = Class44.aShortArray966;
        }

        Class37_Sub9_Sub31.anInt3490 = (((Class37_Sub9_Sub17.anInt3219 ^
            0xffffffff) == -1) ? 43594 : (40000 + PacketParser.world));
        ...
        if (i == -89) {
            Class24.aClass45_604 = Class37_Sub4.method433((byte) 70);
    ...
    public static void main(String[] strings) {
        try {
            ...
            PacketParser.world = Integer.parseInt(strings[0]);//worldid

            if (!strings[1].equals("live")) {//modewhere
            ...
            if (!strings[2].equals("live")) {//modewhat
            ...
            if (strings[3].equals("lowmem")) {//lowmem
            ...
            if (!strings[4].equals("free")) {//members
            ...
            Class37_Sub8.address = "127.0.0.1";//
    ...
    public void init() {
        ...
        if (this.method15(11641)) {
            PacketParser.world = Integer.parseInt(this.getParameter(
                        "worldid"));

            Class37_Sub9_Sub13.anInt3141 = Integer.parseInt(this.getParameter(
                        "modewhat"));

            Class37_Sub9_Sub17.anInt3219 = Integer.parseInt(this.getParameter(
                        "modewhere"));
            ...
            try {
                PacketStream.anInt3610 = Integer.parseInt(this.getParameter(
                            "js"));
            ...
            this.method17(474, 503, Class37_Sub9_Sub13.anInt3141 + 32, 765, (byte) -17);
        }
    }
                    ...
                    try {
                        ...
                        if (i < -76) {
                            ...
                            if (Login.anInt782 == 2) {
                                ...
                                Class80.aLong1505 = Class71.method1263((byte) -80);
                            }
                            ...
                            if ((Login.anInt782 ^ 0xffffffff) == -4) {
                                if ((Class32.anInt740 <= 5) ||
                                    ...
                                    Login.anInt782++;
                                } else if (((-Class80.aLong1505 +
                                        Class71.method1263((byte) -80)) ^
                                        0xffffffffffffffffL) < -30001L) {
                                    method31(-2, true);
        ...
        do {
            try {
                if (Class58.aClass42_1109 != null) {
                    Class58.aClass42_1109.method1079(i ^ ~0x399c);
                }

                if (Class37_Sub4_Sub7_Sub1.aClass42Array3699 != null) {
                    for (int i_6_ = 0;
                            ((Class37_Sub4_Sub7_Sub1.aClass42Array3699.length ^
                            0xffffffff) < (i_6_ ^ 0xffffffff)); i_6_++) {
                        if (Class37_Sub4_Sub7_Sub1.aClass42Array3699[i_6_] != null) {
                            Class37_Sub4_Sub7_Sub1.aClass42Array3699[i_6_].method1079(0);
                        }
                    }
                }
    ...
    public void method25(int i) {
        ...
        ObjectDef.method684(6989);
        ItemDef.method446(-21294);
        ...
        if (i == 43594) {
            ...
            PacketParser.method839((byte) 80);
            ...
            if ((Class32.anInt740 ^ 0xffffffff) == -21) {
                ...
                if ((Class37_Sub9_Sub31.anInt3487 ^ 0xffffffff) != -2) {
                    if (Class37_Sub9_Sub31.anInt3487 == 2) {
                        ...
                        int i_15_ = (((50 * (Class37_Sub4_Sub7_Sub1_Sub1.anInt3942 -
                            Class76.anInt1437)) / Class37_Sub4_Sub7_Sub1_Sub1.anInt3942) +
                            50);
                        Class79.method1298((Class37_Sub9_Sub27.method881(-128,
                                (new JString[] {
                                    Class37_Sub4_Sub18.aJString_2908,
                                    Class87.aJString_1592,
                                    Class37_Sub9_Sub24.method870(i_15_,
                                        (byte) -114), Class50.aJString_1011
                                }))), false, 1);
                    } else {
                        Class79.method1298(Class37_Sub4_Sub18.aJString_2908,
                            false, 1);
                    }
                } else {
                    ...
                    int i_16_ = ((50 * (Class37_Sub9_Sub3.anInt2954 +
                        -anInt1734)) / Class37_Sub9_Sub3.anInt2954);
                    Class79.method1298((Class37_Sub9_Sub27.method881(-110,
                            (new JString[] {
                                Class37_Sub4_Sub18.aJString_2908,
                                Class87.aJString_1592,
                                Class37_Sub9_Sub24.method870(i_16_, (byte) -114),
