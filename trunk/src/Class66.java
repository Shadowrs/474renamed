...
public class Class66 {
    public static JString aJString_1243;
    public static int anInt1244;
    public static int anInt1246;
    public static int anInt1248;
    public static int anInt1253;
    public static JString aJString_1255;
    public static int anInt1257;
    public static JString aJString_1258 = Class37_Sub2.method332((byte) 121,
            " loggt sich ein)3");
    public static JString aJString_1259;
    public static int[] anIntArray1261;
    public static JString aJString_1262 = Class37_Sub2.method332((byte) 122,
            "Walk here");
    public static JString aJString_1263 = aJString_1262;
    public static int anInt1264;

    static {
        aJString_1255 = (Class37_Sub2.method332((byte) 118,
                "RuneScape wird geladen )2 bitte warten)3)3)3"));
        aJString_1259 = Class37_Sub2.method332((byte) 117, "Login");
        aJString_1243 = aJString_1259;
    }
    ...
    public static boolean method1188(int i, Class18 class18) {
        anInt1257++;
        ...
        if (Class37_Sub3_Sub1.aBoolean2328) {
            if ((RuntimeException_Sub1.method1339(class18, 25) ^ 0xffffffff) != -1) {
                return false;
            }
        ...
        return class18.aBoolean445;
    }

    public static int method1189(int i, boolean bool, int i_0_) {
        anInt1248++;

        Class37_Sub13 class37_sub13 = ((Class37_Sub13) Class37_Sub4_Sub7_Sub1.aClass13_3670.method100((byte) 47,
                (long) i));
    ...
    public static void method1190(byte i, int i_1_, int i_2_, int i_3_) {
        if (((Canvas_Sub1.anInt45 ^ 0xffffffff) != -1) && (i_2_ != 0) &&
            ...
            Class37_Sub4_Sub10.anIntArray2681[Class37_Sub3_Sub1.anInt2329] = i_2_;
    ...
    public static void method1191(byte i, int i_4_) {
        ...
        if ((Class27.anIntArray677.length ^ 0xffffffff) > (Class37_Sub9_Sub27.anInt3410 ^
                0xffffffff)) {
            Class37_Sub9_Sub27.anInt3410 -= Class27.anIntArray677.length;

            int i_6_ = (int) (12.0 * Math.random());
            Class47.method1109(-4999,
                (Class37_Sub9_Sub33.aClass37_Sub4_Sub9_Sub1Array3523[i_6_]));
        }
        ...
        for (int i_10_ = 0; (i_9_ ^ 0xffffffff) < (i_10_ ^ 0xffffffff);
                i_10_++) {
            int i_11_ = (-(((Class27.anIntArray677[((-1 +
                Class27.anIntArray677.length) &
                (Class37_Sub9_Sub27.anInt3410 + i_7_))]) * i_4_) / 6) +
        ...
        for (int i_17_ = 0;
                ((i_5_ - i_4_) ^ 0xffffffff) < (i_17_ ^ 0xffffffff); i_17_++)
            Class82.anIntArray1692[i_17_] = Class82.anIntArray1692[i_17_ +
                i_4_];

        for (int i_18_ = -i_4_ + i_5_; i_5_ > i_18_; i_18_++) {
            Class82.anIntArray1692[i_18_] = (int) ((16.0 * Math.sin((double) Class37_Sub1.anInt1808 / 14.0)) +
                (Math.sin((double) Class37_Sub1.anInt1808 / 15.0) * 14.0) +
                (Math.sin((double) Class37_Sub1.anInt1808 / 16.0) * 12.0));
        ...
        if ((i_19_ ^ 0xffffffff) < -1) {
            for (int i_20_ = 0; (Class64.anInt1213 * 100) > i_20_; i_20_++) {
                ...
                Class52_Sub1.anIntArray2298[(i_21_ << 1611242727) + i_22_] = 192;
            }
            ...
            for (int i_23_ = 0; (i_5_ ^ 0xffffffff) < (i_23_ ^ 0xffffffff);
                ...
                for (int i_26_ = -i_19_; (i_26_ ^ 0xffffffff) > -129;
                        i_26_++) {
                    if ((i_19_ + i_26_) < 128) {
                        i_24_ += Class52_Sub1.anIntArray2298[i_26_ -
                        (-i_25_ + -i_19_)];
                    }
                    ...
                    if (i_26_ >= 0) {
                        Class33.anIntArray754[i_26_ + i_25_] = i_24_ / (1 +
                            (2 * i_19_));
                    }
                }
            }
            ...
            for (int i_27_ = 0; i_27_ < 128; i_27_++) {
                ...
                for (int i_29_ = -i_19_; i_5_ > i_29_; i_29_++) {
                    ...
                    if (((i_29_ + i_19_) ^ 0xffffffff) > (i_5_ ^ 0xffffffff)) {
                        i_28_ += (Class33.anIntArray754[i_30_ +
                        (i_27_ - -(i_19_ * 128))]);
                    }

                    if (((i_29_ + (-i_19_ + -1)) ^ 0xffffffff) <= -1) {
                        i_28_ -= (Class33.anIntArray754[(i_30_ + i_27_) -
                        (128 + (128 * i_19_))]);
                    }

                    if (i_29_ >= 0) {
                        Class52_Sub1.anIntArray2298[i_27_ - -i_30_] = i_28_ / ((2 * i_19_) -
                            -1);
                    }
                }
            }
