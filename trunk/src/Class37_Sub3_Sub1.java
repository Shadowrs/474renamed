...
public class Class37_Sub3_Sub1 extends Class37_Sub3 {
    ...
    public static JString aJString_2320;
    public static int anInt2321;
    public static int anInt2322;
    public static int anInt2323;
    public static JString aJString_2324 = Class37_Sub2.method332((byte) 113,
            "Bitte warten Sie eine Minute");
    public static int anInt2325;
    public static JString aJString_2326;
    public static JString aJString_2327;
    ...
    static {
        ...
        aJString_2320 = Class37_Sub2.method332((byte) 122,
                "Your profile will be transferred in:");
        aJString_2326 = Class37_Sub2.method332((byte) 124, ": ");
        aBoolean2328 = false;
        anInt2329 = 0;
        aJString_2327 = aJString_2320;
    }

    public Class58 aClass58_2316 = new Class58();
    ...
    public Class37_Sub3 method339() {
        ...
        do {
            class37_sub12 = (Class37_Sub12) aClass58_2316.method1162((byte) 105);
    ...
    public void method344(int i, byte i_0_, int[] is, int i_1_, int i_2_,
        ...
        try {
            ...
            if (((((aClass37_Sub3_Sub3_2317.anIntArray2383[class37_sub12.anInt2078]) &
                    0x4) ^ 0xffffffff) != -1) &&
                    ((class37_sub12.anInt2088 ^ 0xffffffff) > -1)) {
                int i_4_ = ((aClass37_Sub3_Sub3_2317.anIntArray2340[class37_sub12.anInt2078]) / Class33.anInt765);

                for (;;) {
                    int i_5_ = (i_4_ + (1048575 + -class37_sub12.anInt2102)) / i_4_;
                    ...
                    Class37_Sub3_Sub4 class37_sub3_sub4 = class37_sub12.aClass37_Sub3_Sub4_2084;
                    i_1_ += i_5_;
                    ...
                    if ((aClass37_Sub3_Sub3_2317.anIntArray2385[class37_sub12.anInt2078]) == 0) {
                        class37_sub12.aClass37_Sub3_Sub4_2084 = (Class37_Sub3_Sub4.method391(class37_sub12.aClass37_Sub22_Sub1_2098,
                        ...
                        class37_sub12.aClass37_Sub3_Sub4_2084 = (Class37_Sub3_Sub4.method391(class37_sub12.aClass37_Sub22_Sub1_2098,
                                ...
                                class37_sub3_sub4.method425()));
                        aClass37_Sub3_Sub3_2317.method366((class37_sub12.aClass37_Sub15_2091.aShortArray2147[(class37_sub12.anInt2099)]) < 0,
                            true, class37_sub12);
                        class37_sub12.aClass37_Sub3_Sub4_2084.method401(i_6_,
                            class37_sub3_sub4.method417());
                    }

                    if ((class37_sub12.aClass37_Sub15_2091.aShortArray2147[class37_sub12.anInt2099]) < 0) {
...
while_15_: 
        for (Class37_Sub12 class37_sub12 = (Class37_Sub12) aClass58_2316.method1155(
                    0); class37_sub12 != null;
                class37_sub12 = (Class37_Sub12) aClass58_2316.method1162(
                        (byte) 78)) {
            if (!aClass37_Sub3_Sub3_2317.method368(1609320623, class37_sub12)) {
                int i_8_ = i;
...
while_17_: 
        for (Class37_Sub12 class37_sub12 = (Class37_Sub12) aClass58_2316.method1155(
            ...
            if (!aClass37_Sub3_Sub3_2317.method368(1609320623, class37_sub12)) {
                ...
                while ((i_11_ ^ 0xffffffff) < (class37_sub12.anInt2082 ^
                        0xffffffff)) {
    ...
    public void method346(int i, Class37_Sub12 class37_sub12, int i_12_) {
        if ((((0x4 &
                (aClass37_Sub3_Sub3_2317.anIntArray2383[class37_sub12.anInt2078])) ^
                0xffffffff) != -1) &&
                ((class37_sub12.anInt2088 ^ 0xffffffff) > -1)) {
            int i_13_ = ((aClass37_Sub3_Sub3_2317.anIntArray2340[class37_sub12.anInt2078]) / Class33.anInt765);
            int i_14_ = (i_13_ + (1048575 - class37_sub12.anInt2102)) / i_13_;

            class37_sub12.anInt2102 = 0xfffff &
                ((i_13_ * i_12_) + class37_sub12.anInt2102);
            ...
            if (i_14_ <= i_12_) {
                if ((aClass37_Sub3_Sub3_2317.anIntArray2385[class37_sub12.anInt2078]) == 0) {
                    class37_sub12.aClass37_Sub3_Sub4_2084 = (Class37_Sub3_Sub4.method391(class37_sub12.aClass37_Sub22_Sub1_2098,
                            ...
                            class37_sub12.aClass37_Sub3_Sub4_2084.method425()));
                } else {
                    class37_sub12.aClass37_Sub3_Sub4_2084 = (Class37_Sub3_Sub4.method391(class37_sub12.aClass37_Sub22_Sub1_2098,
                            class37_sub12.aClass37_Sub3_Sub4_2084.method420(),
                            0, class37_sub12.aClass37_Sub3_Sub4_2084.method425()));
                    aClass37_Sub3_Sub3_2317.method366((class37_sub12.aClass37_Sub15_2091.aShortArray2147[(class37_sub12.anInt2099)]) < 0,
                        true, class37_sub12);
                }
    ...
    public Class37_Sub3 method343() {
        ...
        Class37_Sub12 class37_sub12 = (Class37_Sub12) aClass58_2316.method1155(0);
