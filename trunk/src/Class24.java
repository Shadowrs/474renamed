...
public class Class24 {
    public static JString aJString_596;
    public static JString aJString_597;
    ...
    public static JString aJString_616;
    public static JString aJString_618;
    ...
    static {
        ...
        aJString_616 = (Class37_Sub2.method332((byte) 127,
                "Your ignore list is full)3 Max of 100 users)3"));
        aJString_618 = Class37_Sub2.method332((byte) 114, "Lade)3)3)3");
        aJString_596 = aJString_616;
        aJString_597 = Class37_Sub2.method332((byte) 109, "Passwort: ");
    }
...
while_55_: 
            while (i_6_ != 0) {
                ...
                for (int i_10_ = i_6_ >>> i_8_ & 0x11111111; i_10_ != 0;
                    ...
                    if ((i_10_ & 0x1) != 0) {
                        ...
                        Class37_Sub3 class37_sub3_11_ = aClass37_Sub3Array630[i_8_];

                        while (class37_sub3_11_ != null) {
                            Class37_Sub22 class37_sub22 = class37_sub3_11_.aClass37_Sub22_1839;
                            ...
                            if ((class37_sub22 != null) &&
                                ...
                                class37_sub3_11_ = class37_sub3_11_.aClass37_Sub3_1841;
                            } else {
                                ...
                                Class37_Sub3 class37_sub3_13_ = class37_sub3_11_.method343();

                                if (class37_sub3_13_ != null) {
                                    int i_14_ = class37_sub3_11_.anInt1840;

                                    for (; class37_sub3_13_ != null;
                                            class37_sub3_13_ = class37_sub3_11_.method339())
                                        method244(((i_14_ * class37_sub3_13_.method342()) >> 8),
                                            class37_sub3_13_, false);
                                }

                                Class37_Sub3 class37_sub3_15_ = class37_sub3_11_.aClass37_Sub3_1841;
                                class37_sub3_11_.aClass37_Sub3_1841 = null;

                                if (class37_sub3 == null) {
                                    aClass37_Sub3Array630[i_8_] = class37_sub3_15_;
                                } else {
                                    class37_sub3.aClass37_Sub3_1841 = class37_sub3_15_;
                                }
            ...
            for (int i_16_ = 0; i_16_ < 8; i_16_++) {
                ...
                aClass37_Sub3Array630[i_16_] = aClass37_Sub3Array634[i_16_] = null;

                Class37_Sub3 class37_sub3_17_;

                for (; class37_sub3 != null; class37_sub3 = class37_sub3_17_) {
    ...
    public synchronized void method248(int i) {
        ...
        if (anIntArray606 != null) {
            ...
            try {
                if (aLong629 != 0L) {
                    if ((l ^ 0xffffffffffffffffL) > (aLong629 ^
                            0xffffffffffffffffL)) {
                        return;
                    }
                ...
                if (((-i_18_ + anInt627) ^ 0xffffffff) < (anInt632 ^
                        0xffffffff)) {
    ...
    public static void method249(int i, int i_20_) {
        ...
        Class37_Sub13 class37_sub13 = ((Class37_Sub13) Class37_Sub4_Sub7_Sub1.aClass13_3670.method100((byte) 34,
                (long) i));

        if (class37_sub13 != null) {
            for (int i_21_ = i_20_;
                    ((i_21_ ^ 0xffffffff) > (class37_sub13.anIntArray2116.length ^
                    0xffffffff)); i_21_++) {
