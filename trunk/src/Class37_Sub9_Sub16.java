...
public class Class37_Sub9_Sub16 extends Class37_Sub9 {
    ...
    public static JString aJString_3191 = Class37_Sub2.method332((byte) 101,
            "Bitte starten Sie eine Mitgliedschaft");
    public static int anInt3192;
    public static int anInt3194;
    public static JString aJString_3195;
    public static int anInt3196;
    public static JString aJString_3197 = Class37_Sub2.method332((byte) 117,
            "Angreifen");
    ...
    public static JString aJString_3204;
    public static int anInt3205;
    public static JString aJString_3206;
    public static int anInt3208;
    public static int anInt3209;

    static {
        aJString_3195 = Class37_Sub2.method332((byte) 107, "Lade Titelbild )2 ");
        anInt3201 = 0;
        aJString_3204 = Class37_Sub2.method332((byte) 115, "null");
        anInt3192 = 0;

        aJString_3206 = Class37_Sub2.method332((byte) 117,
                "W-=hlen Sie eine Welt");
        anInt3208 = 0;
    }
    ...
    public int[] method761(int i, int i_0_) {
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_4_ = 0;
                ...
                for (int i_7_ = 0;
                        (i_7_ ^ 0xffffffff) > (anInt3186 ^ 0xffffffff);
                        i_7_++) {
                    int i_8_ = anIntArray3189[i_7_];
                    int i_9_ = anIntArray3188[i_7_];
                    int i_10_ = method829((byte) -74,
                            (i_2_ * i_8_) >> -1484813940,
    ...
    public static void method828(int i, int i_11_, int i_12_, int i_13_,
        ...
        if ((i_17_ >= 1) && ((i_14_ ^ 0xffffffff) <= -2) &&
            ...
            if (!Class37_Sub4_Sub6.aBoolean2613 ||
                    ((Class37_Sub9_Sub1.anInt2916 ^ 0xffffffff) == (i_15_ ^
                    0xffffffff))) {
                int i_18_ = 0;

                if (i_13_ == 0) {
                    i_18_ = Class38.aClass67_847.method1230(i_15_, i_17_, i_14_);
                }
                ...
                if (i_13_ == 1) {
                    i_18_ = Class38.aClass67_847.method1202(i_15_, i_17_, i_14_);
                }

                boolean bool_20_ = false;

                if ((i_13_ ^ 0xffffffff) == -3) {
                    i_18_ = Class38.aClass67_847.method1228(i_15_, i_17_, i_14_);
                }

                if (i_13_ == 3) {
                    i_18_ = Class38.aClass67_847.method1199(i_15_, i_17_, i_14_);
                }
                ...
                if (i_18_ != 0) {
                    ...
                    if ((i_13_ ^ 0xffffffff) == -1) {
                        ...
                        if (objectdef.anInt2740 != 0) {
                            Class68.aClass20Array1322[i_15_].method221(i_23_,
                                i_14_, i_22_, i_17_,
                                objectdef.ProjectileBlocked, 106);
                        }
                    }
                    ...
                    if (i_13_ == 2) {
                        ...
                        if ((((i_17_ + objectdef.tileWidth) ^
                                0xffffffff) < -104) ||
                                ((i_14_ + objectdef.tileWidth) > 103) ||
                                (((i_17_ + objectdef.tileDepth) ^
                                0xffffffff) < -104) ||
                                ((objectdef.tileDepth + i_14_) > 103)) {
                            return;
                        }

                        if (objectdef.anInt2740 != 0) {
                            Class68.aClass20Array1322[i_15_].method226(i_17_,
                                objectdef.ProjectileBlocked, i_22_,
                                objectdef.tileWidth,
                                objectdef.tileDepth, (byte) -73, i_14_);
                        }
                    }
                    ...
                    if (i_13_ == 3) {
                        ...
                        if (objectdef.anInt2740 == 1) {
                            Class68.aClass20Array1322[i_15_].method214(i_17_,
                                i_14_, 123);
                        }
                    }
                }
                ...
                if ((i_11_ ^ 0xffffffff) <= -1) {
                    ...
                    Class37_Sub25.method1046(i_15_, i, -116, i_24_,
                        Class68.aClass20Array1322[i_15_], i_16_, i_14_, i_11_,
                        i_17_, Class38.aClass67_847);
                }
            }
        }
    }
    ...
    public int method829(byte i, int i_25_, int i_26_, int i_27_, int i_28_) {
        ...
        int i_46_ = RuntimeException_Sub1.method1340(i_41_, true, i_44_, i_40_);
        int i_47_ = RuntimeException_Sub1.method1340(i_43_, true, i_44_, i_42_);
    ...
    public void method831(int i) {
        ...
        if (anInt3190 <= 0) {
            if ((anIntArray3188 != null) &&
                ...
                for (int i_48_ = 0;
                        (i_48_ ^ 0xffffffff) > (anInt3186 ^ 0xffffffff);
                        i_48_++)
                    anIntArray3189[i_48_] = (int) (Math.pow(2.0, (double) i_48_) * 4096.0);
            }
        } else {
            anIntArray3189 = new int[anInt3186];
            ...
            for (int i_49_ = 0; i_49_ < anInt3186; i_49_++) {
                anIntArray3188[i_49_] = (int) (Math.pow((double) (anInt3190 / 4096),
                        (double) i_49_) * 4096.0);

                anIntArray3189[i_49_] = (int) (4096.0 * Math.pow(2.0,
                        (double) i_49_));
            }
        }
