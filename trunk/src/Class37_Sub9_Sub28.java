...
public class Class37_Sub9_Sub28 extends Class37_Sub9 {
    public static JString aJString_3420 = Class37_Sub2.method332((byte) 116,
    ...
    public static Class58 aClass58_3427 = new Class58();
    ...
    public static JString aJString_3435 = Class37_Sub2.method332((byte) 107,
            "Regeln versto-8en hat)3");
    public static JString aJString_3436;
    public static JString aJString_3437;
    public static JString aJString_3438 = Class37_Sub2.method332((byte) 121,
            "Choose Option");
    public static JString aJString_3439;
    public static int anInt3440;

    static {
        aJString_3437 = Class37_Sub2.method332((byte) 118,
                "Prepared visibility map");
        anInt3440 = 0;
        aJString_3439 = aJString_3438;
        aJString_3436 = aJString_3437;
    }
    ...
    public static void method884(int i) {
        ...
        if ((Class13.anIntArray226 == null) ||
            ...
            for (int i_16_ = 0; (i_16_ ^ 0xffffffff) > -257; i_16_++) {
                ...
                Class37_Sub4_Sub7_Sub2.anIntArray3711[i_16_] = (int) (4096.0 * Math.cos(d));
            }
        }
    ...
    public static void method885(
        Class37_Sub4_Sub7_Sub1 class37_sub4_sub7_sub1, int i, byte i_18_) {
        anInt3423++;
        Class37_Sub4_Sub10.method677(i, class37_sub4_sub7_sub1.anInt3666,
            class37_sub4_sub7_sub1.anInt3642, (byte) -125);
    ...
    public static int method886(int i, int i_19_, byte i_20_) {
        ...
        int i_22_ = (((i_21_ * (789221 + (15731 * (i_21_ * i_21_)))) +
            ...
            do {
                do {
                    if ((i_23_ ^ 0xffffffff) != -1) {
                        ...
                        anInt3425 = stream.readShort();

                        return;
                    }

                    anInt3431 = stream.readShort();

                    return;
                } while (false);

                anInt3433 = stream.readShort();
            } while (false);
        }
    }
}
