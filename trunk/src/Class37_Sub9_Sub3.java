...
public class Class37_Sub9_Sub3 extends Class37_Sub9 {
    ...
    public static JString aJString_2939;
    ...
    public static JString aJString_2949 = Class37_Sub2.method332((byte) 121,
            ")2");
    ...
    public static JString aJString_2955;
    public static JString aJString_2956;

    static {
        aJString_2939 = Class37_Sub2.method332((byte) 122, "null");
        aClass65_2940 = new Class65(64);
        anInt2954 = 1;
        aJString_2956 = Class37_Sub2.method332((byte) 101, "<br>(X100(U(Y");
        aJString_2955 = Class37_Sub2.method332((byte) 107, "leuchten2:");
    }
        ...
        do {
            try {
                ...
                if (Class43.aClass51_958.anApplet1045 != null) {
                    SignlinkResourceNode class23 = (Class43.aClass51_958.method1122((byte) 40,
    ...
    public static Class37_Sub4_Sub9_Sub2_Sub1 method770(Class15 class15, int i,
        ...
        try {
            ...
            return Class37_Sub4_Sub5.method484(class15_2_.method131(i, i_3_, 1),
                110);
        } catch (RuntimeException runtimeexception) {
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("bg.B(" + ((class15 != null) ? "{...}" : "null") + ',' + i +
    ...
    public static void method771(int i,
        ...
        if (Class37_Sub7.anInt1898 < class37_sub4_sub7_sub1.anInt3648) {
            Class37_Sub9_Sub20.method852(class37_sub4_sub7_sub1, true);
        } else if ((class37_sub4_sub7_sub1.anInt3667 ^ 0xffffffff) <= (Class37_Sub7.anInt1898 ^
                0xffffffff)) {
            RSApplet.method82(128, class37_sub4_sub7_sub1);
        } else {
        ...
        if ((class37_sub4_sub7_sub1.anInt3666 < 128) ||
            ...
            class37_sub4_sub7_sub1.anInt3667 = 0;
            class37_sub4_sub7_sub1.anInt3636 = -1;
            class37_sub4_sub7_sub1.anInt3655 = -1;

            class37_sub4_sub7_sub1.anInt3666 = ((class37_sub4_sub7_sub1.anIntArray3651[0] * 128) +
                (64 * class37_sub4_sub7_sub1.anInt3683));

            class37_sub4_sub7_sub1.anInt3642 = ((class37_sub4_sub7_sub1.anInt3683 * 64) +
                (128 * class37_sub4_sub7_sub1.anIntArray3669[0]));
            class37_sub4_sub7_sub1.anInt3648 = 0;
        ...
        if ((class37_sub4_sub7_sub1 == Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234) &&
                ...
                ((class37_sub4_sub7_sub1.anInt3666 ^ 0xffffffff) <= -11777) ||
                ((class37_sub4_sub7_sub1.anInt3642 ^ 0xffffffff) <= -11777))) {
            class37_sub4_sub7_sub1.anInt3666 = ((64 * class37_sub4_sub7_sub1.anInt3683) +
                (128 * class37_sub4_sub7_sub1.anIntArray3651[0]));
            class37_sub4_sub7_sub1.anInt3636 = -1;
            class37_sub4_sub7_sub1.anInt3655 = -1;
            class37_sub4_sub7_sub1.anInt3648 = 0;
            class37_sub4_sub7_sub1.anInt3667 = 0;

            class37_sub4_sub7_sub1.anInt3642 = ((64 * class37_sub4_sub7_sub1.anInt3683) +
                (class37_sub4_sub7_sub1.anIntArray3669[0] * 128));
    ...
    public static Class37_Sub9 method772(Stream stream,
        boolean bool) {
        anInt2948++;
    ...
    public static void method773(byte i, int i_9_, int i_10_, int i_11_,
        ...
        if ((class37_sub4_sub7_sub1_sub2 != Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234) &&
            ...
            if (class37_sub4_sub7_sub1_sub2.anInt3961 == 0) {
                jstring = (Class37_Sub9_Sub27.method881(-48,
                        (new JString[] {
                            ...
                            (Class37_Sub9_Sub24.method870(
                                class37_sub4_sub7_sub1_sub2.anInt3978,
                                (byte) -114)), Class25.aJString_644
                        })));
            } else {
                jstring = (Class37_Sub9_Sub27.method881(120,
                        (new JString[] {
                            class37_sub4_sub7_sub1_sub2.aJString_3993,
                            Class37_Sub9_Sub24.aJString_3370,
                            Class37_Sub9_Sub5.aJString_2996,
                            (Class37_Sub9_Sub24.method870(
            ...
            if ((Class37_Sub14.anInt2122 ^ 0xffffffff) != -2) {
                if (!Class37_Sub4_Sub5.aBoolean2595) {
                    for (int i_12_ = 7; (i_12_ ^ 0xffffffff) <= -1; i_12_--) {
                        if (Class75.aJStringArray1413[i_12_] != null) {
                            Stream.anInt2016++;
                            ...
                            if (!Class75.aJStringArray1413[i_12_].method159(
                                ...
                                if (((Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.anInt3988) != 0) &&
                                    ...
                                    if (((Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.anInt3988) ^
                                            0xffffffff) != ((class37_sub4_sub7_sub1_sub2.anInt3988) ^
                                            0xffffffff)) {
                                        i_13_ = 0;
                                    } else {
                                        i_13_ = 2000;
                            ...
                            method774(i_14_, i_11_,
                                Class75.aJStringArray1413[i_12_], i_9_, true,
                                (Class37_Sub9_Sub27.method881(122,
                                    new JString[] { Class25.aJString_636, jstring })),
                                i_10_);
                        }
                    }
                } else if (((0x8 & Class37_Sub4_Sub12.anInt2759) ^ 0xffffffff) == -9) {
                    method774(34, i_11_, Class37_Sub9_Sub1.aJString_2912, i_9_,
                        true,
                        (Class37_Sub9_Sub27.method881(-102,
                            new JString[] {
                                Class60.aJString_1142, Class54.aJString_1061,
                                jstring
                            })), i_10_);
                    Class72.anInt1373++;
                }
                ...
                Class14.anInt251++;
                method774(22, i_11_, Class37_Sub9_Sub27.aJString_3404, i_9_,
                    true,
                    (Class37_Sub9_Sub27.method881(-81,
                        new JString[] {
                            Class64.aJString_1218, Class54.aJString_1061,
                            jstring
                        })), i_10_);
            }

            for (int i_15_ = 0;
                    ((i_15_ ^ 0xffffffff) > (Class37_Sub9_Sub13.anInt3134 ^
                    0xffffffff)); i_15_++) {
                if ((Class37_Sub9_Sub20.anIntArray3300[i_15_] ^ 0xffffffff) == -3) {
                    Class37_Sub9_Sub37.aJStringArray3593[i_15_] = Class37_Sub9_Sub27.method881(5,
                            (new JString[] { Class25.aJString_636, jstring }));
    ...
    public static void method774(int i, int i_17_, JString jstring, int i_18_,
        boolean bool, JString jstring_19_, int i_20_) {
        do {
            try {
                anInt2953++;
                ...
                if (!Class37_Sub20.aBoolean2220) {
                    ...
                    Class37_Sub9_Sub14.aJStringArray3151[(Class37_Sub9_Sub13.anInt3134)] = jstring;

                    Class37_Sub9_Sub37.aJStringArray3593[(Class37_Sub9_Sub13.anInt3134)] = jstring_19_;
                    ...
                    Class58.anIntArray1128[Class37_Sub9_Sub13.anInt3134] = i_18_;
                ...
                throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                    ("bg.C(" + i + ',' + i_17_ + ',' +
                    ((jstring != null) ? "{...}" : "null") + ',' + i_18_ + ',' +
                    bool + ',' + ((jstring_19_ != null) ? "{...}" : "null") +
                    ',' + i_20_ + ')'));
            }
    ...
    public int[] method761(int i, int i_21_) {
        ...
        if (aClass38_1966.aBoolean850) {
            for (int i_22_ = 0; i_22_ < Class32.anInt743; i_22_++) {
                ...
                int i_24_ = i_23_;
                int i_25_ = anInt2942 +
                    ((Class37_Sub4_Sub16.anIntArray2871[i_21_] << 1374709964) / anInt2944);
                int i_26_ = i_25_;
                ...
                for (i_31_ = 0;
                        ((((i_27_ - -i_30_) ^ 0xffffffff) > -16385) &&
                        (i_31_ < anInt2941));
                        i_30_ = (i_29_ * i_29_) >> -473554036) {
                    i_31_++;
                ...
                is[i_22_] = ((((-1 + anInt2941) ^ 0xffffffff) >= (i_31_ ^
                    0xffffffff)) ? 0 : ((i_31_ << -1950612276) / anInt2941));
            }
        }
