...
public class Class73 {
    public static JString aJString_1378 = Class37_Sub2.method332((byte) 126,
            "Loading fonts )2 ");
    public static int anInt1381;
    public static int anInt1382;
    public static int anInt1383;
    public static JString aJString_1384;
    public static JString aJString_1385;
    ...
    static {
        anInt1388 = 0;
        aJString_1384 = Class37_Sub2.method332((byte) 114, ")4l");
        aJString_1385 = Class37_Sub2.method332((byte) 111, "flash3:");
        aJString_1386 = aJString_1385;
    ...
    public Class37_Sub22_Sub1 method1272(int i, int i_0_, int[] is, byte i_1_) {
        ...
        Class37_Sub22_Sub1 class37_sub22_sub1 = (Class37_Sub22_Sub1) aClass13_1396.method100((byte) 115,
                l);
        ...
        Class37_Sub24 class37_sub24 = (Class37_Sub24) aClass13_1380.method100((byte) 67,
                l);
    ...
    public static void method1273(int i) {
        ...
        int i_5_ = (ObjectDef.anInt2697 * 128) - -64;
        ...
        if ((i_6_ ^ 0xffffffff) < (Class37_Sub25.anInt2286 ^ 0xffffffff)) {
            Class37_Sub25.anInt2286 += ((((-Class37_Sub25.anInt2286 + i_6_) * Class76.anInt1438) / 1000) +
            Class37_Sub8.anInt1932);
        ...
        if ((i_5_ ^ 0xffffffff) < (Class37_Sub6.anInt1888 ^ 0xffffffff)) {
            Class37_Sub6.anInt1888 += ((((-Class37_Sub6.anInt1888 + i_5_) * Class76.anInt1438) / 1000) +
            Class37_Sub8.anInt1932);
        ...
        if (Class37_Sub6.anInt1888 > i_5_) {
            Class37_Sub6.anInt1888 -= (((Class76.anInt1438 * (-i_5_ +
            Class37_Sub6.anInt1888)) / 1000) + Class37_Sub8.anInt1932);
        ...
        int i_11_ = ((int) (325.949 * Math.atan2((double) i_9_, (double) i_10_)) &
            0x7ff);
        int i_12_ = ((int) (-325.949 * Math.atan2((double) i_7_, (double) i_8_)) &
            0x7ff);
    ...
    public static void method1274(Class18 class18, int i) {
        anInt1394++;

        if (i == -1) {
            if (class18.anInt343 == Class13.anInt216) {
                Class37_Sub4_Sub7_Sub1_Sub1.aBooleanArray3948[class18.anInt458] = true;
            }
        }
    }
    ...
    public Class37_Sub22_Sub1 method1276(int[] is, int i, int i_16_, byte i_17_) {
        ...
        long l = (long) i_18_;
        Class37_Sub22_Sub1 class37_sub22_sub1 = (Class37_Sub22_Sub1) aClass13_1396.method100((byte) 68,
                l);
