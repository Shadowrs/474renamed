...
public class Class37_Sub9_Sub2 extends Class37_Sub9 {
    ...
    public static JString aJString_2928 = Class37_Sub2.method332((byte) 108,
            "Lade Konfiguration )2 ");
    public static int anInt2929;
    public static JString aJString_2930;
    public static Class15_Sub1 aClass15_Sub1_2932;
    public static JString aJString_2933;
    ...
    static {
        aJString_2933 = Class37_Sub2.method332((byte) 125, "Welt");

        aJString_2930 = (Class37_Sub2.method332((byte) 113,
                "und haben es deaktiviert)3 Klicken Sie auf der"));
    }
    ...
    public int[][] method759(byte i, int i_0_) {
        ...
        if (aClass33_1946.aBoolean767) {
            int[] is_1_ = this.method760(((i_0_ - 1) &
                    Class37_Sub4_Sub7_Sub1_Sub2.anInt3989), 0, -127);
            ...
            for (int i_7_ = 0;
                ...
                int i_14_ = (int) (Math.sqrt((double) ((4096 + i_12_ + i_13_) / 4096)) * 4096.0);
                int i_15_;
                int i_16_;
                int i_17_;
    ...
    public void method750(Stream stream, int i, boolean bool) {
        ...
        do {
            if (i_18_ != 0) {
                ...
                anInt2931 = stream.method980(64);

                break;
            }

            aBoolean2927 = stream.method978(121) == 1;
        } while (false);
    }
    ...
    public static boolean method767(int i, byte i_20_, int i_21_) {
        ...
        ObjectDef objectdef = Class37_Sub9_Sub8.method794(i_21_,
                28067);
        ...
        return objectdef.method686(i, -13979);
    }
}
