...
public class Class37_Sub9_Sub18 extends Class37_Sub9 {
    ...
    public static JString aJString_3230;
    public static int anInt3231;
    public static int anInt3232;
    public static int[] anIntArray3233;
    public static JString aJString_3234;
    public static JString aJString_3235;
    public static JString aJString_3236;
    public static JString aJString_3237 = Class37_Sub2.method332((byte) 111,
            "purple:");
    public static Class58[][][] aClass58ArrayArrayArray3238 = new Class58[4][104][104];
    public static JString aJString_3239;
    public static JString aJString_3240;
    public static int anInt3241;
    public static int anInt3242;
    public static JString aJString_3243;
    public static JString aJString_3245;
    public static int anInt3246;

    static {
        anIntArray3233 = new int[] { 768, 1024, 1280, 512, 1536, 256, 0, 1792 };
        aJString_3234 = aJString_3237;
        aJString_3243 = aJString_3237;

        aJString_3239 = Class37_Sub2.method332((byte) 124,
                "Your account is already logged in)3");
        aJString_3236 = Class37_Sub2.method332((byte) 107, "welle:");
        aJString_3245 = Class37_Sub2.method332((byte) 113, "green:");
        aJString_3235 = aJString_3245;
        aJString_3240 = aJString_3239;
        aJString_3230 = aJString_3245;
    }
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_4_ = i_0_ + -anInt3228;
                ...
                for (int i_8_ = -anInt3244;
                        (i_8_ ^ 0xffffffff) >= (anInt3244 ^ 0xffffffff);
                        i_8_++)
    ...
    public static int method837(Stream stream, int i,
        JString jstring) {
        try {
            anInt3232++;
