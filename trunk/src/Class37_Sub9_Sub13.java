...
public class Class37_Sub9_Sub13 extends Class37_Sub9 {
    ...
    public static JString aJString_3129;
    public static JString aJString_3130 = Class37_Sub2.method332((byte) 108,
            "The server is being updated)3");
    public static JString aJString_3131;
    ...
    public static Stream aStream_3140;
    public static int anInt3141;
    public static JString aJString_3142;

    static {
        aJString_3129 = Class37_Sub2.method332((byte) 103, "(Z");
        aJString_3131 = aJString_3130;
        anInt3134 = 0;
        aClass21_3126 = new Class21();
        aStream_3140 = new Stream(new byte[5000]);

        aJString_3142 = Class37_Sub2.method332((byte) 126,
            ...
            if (i_1_ > 0) {
                for (int i_6_ = 0; Class32.anInt743 > i_6_; i_6_++) {
                    ...
                    for (int i_9_ = 0;
                            ...
                            i_9_++) {
                        if ((anIntArrayArray3135[i_9_][0] ^ 0xffffffff) < (i_8_ ^
                                0xffffffff)) {
                            break;
                        }
                    ...
                    if ((i_7_ ^ 0xffffffff) <= (i_1_ ^ 0xffffffff)) {
                        ...
                        if ((i_7_ ^ 0xffffffff) < -1) {
                            ...
                            int i_13_ = (((i_8_ + -is_12_[0]) << -291318036) / (-is_12_[0] +
                                is_11_[0]));
                            int i_14_ = 4096 + -i_13_;

                            is_3_[i_6_] = (((i_14_ * is_12_[1]) +
                                (i_13_ * is_11_[1])) >> -76443316);

                            is_4_[i_6_] = (((is_12_[2] * i_14_) +
                                (is_11_[2] * i_13_)) >> 1794492588);
    ...
    public static void method812(int i) {
        ...
        for (int i_18_ = 0; Class37_Sub3_Sub1.anInt2329 > i_18_; i_18_++) {
            ...
            if ((Class83.anIntArray1520[i_18_] ^ 0xffffffff) > 9) {
                ...
                for (int i_19_ = i_18_;
                        ((Class37_Sub3_Sub1.anInt2329 ^ 0xffffffff) < (i_19_ ^
                        0xffffffff)); i_19_++) {
                    Class46.anIntArray988[i_19_] = Class46.anIntArray988[1 +
                        i_19_];

                    Class37_Sub9_Sub32.aClass11Array3505[i_19_] = Class37_Sub9_Sub32.aClass11Array3505[i_19_ +
                        1];

                    Class37_Sub4_Sub10.anIntArray2681[i_19_] = Class37_Sub4_Sub10.anIntArray2681[i_19_ -
                        -1];

                    Class83.anIntArray1520[i_19_] = Class83.anIntArray1520[1 +
                        i_19_];

                    Class37_Sub4_Sub13.anIntArray2800[i_19_] = Class37_Sub4_Sub13.anIntArray2800[1 +
                        i_19_];
                }
                ...
                if (class11 == null) {
                    class11 = Class11.method88(Class37_Sub4.aClass15_Sub1_1862,
                ...
                if (Class83.anIntArray1520[i_18_] < 0) {
                    ...
                    if (Class37_Sub4_Sub13.anIntArray2800[i_18_] != 0) {
                        int i_21_ = 128 * (0xff &
                            (Class37_Sub4_Sub13.anIntArray2800[i_18_]));
                        int i_22_ = ((0xff8bf6 &
                            Class37_Sub4_Sub13.anIntArray2800[i_18_]) >> -2098238512);
                        int i_23_ = (64 + (128 * i_22_) +
                        ...
                        int i_24_ = 0xff &
                            (Class37_Sub4_Sub13.anIntArray2800[i_18_] >> -2039899320);
                        int i_25_ = ((128 * i_24_) +
                            (64 +
    ...
    public static void method814(int i) {
        ...
        for (int i_29_ = 0;
                ((Class37_Sub9_Sub37.anInt3597 ^ 0xffffffff) < (i_29_ ^
                0xffffffff)); i_29_++) {
        ...
        if ((Class37_Sub4_Sub13.anInt2793 ^ 0xffffffff) == -4) {
            for (int i_30_ = 0; Class37_Sub9_Sub37.anInt3597 > i_30_;
                    i_30_++) {
                if (!Class37_Sub9_Sub36.aBooleanArray3587[i_30_]) {
                    if (Class37_Sub9_Sub1.aBooleanArray2920[i_30_]) {
                        Class37_Sub4_Sub9.method586(Class71.anIntArray1364[i_30_],
                            ...
                            PacketStream.anIntArray3611[i_30_],
        ...
        Class18.method192((Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.anInt3666),
