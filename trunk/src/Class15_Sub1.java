...
public class Class15_Sub1 extends Class15 {
    ...
    public static JString aJString_1757 = Class37_Sub2.method332((byte) 119,
            "rect_debug=");
    ...
    public Class15_Sub1(Class69 class69, Class69 class69_3_, int i,
        ...
        try {
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("ob.<init>(" + ((class69 != null) ? "{...}" : "null") + ',' +
                ((class69_3_ != null) ? "{...}" : "null") + ',' + i + ',' +
                bool + ',' + bool_4_ + ',' + bool_5_ + ')'));
        }
    }
    ...
    public void method137(int i, byte i_11_, byte[] is, boolean bool,
        ...
        if (i_11_ == 97) {
            if (!bool) {
                ...
                if (bool_12_) {
                    anObjectArray278[i] = Class88.method1332(false, is, (byte) 2);
                }
            } else {
                if (aBoolean1751) {
    ...
    public void method139(byte i, int i_13_, int i_14_) {
        ...
        if (aClass69_1737 == null) {
            ...
            Class37_Sub9_Sub33.method901(aClass69_1737, anInt1747, this, false);
        }
    }
    ...
    public void method141(int i) {
        ...
        if (i > 82) {
            ...
            if (aClass69_1743 == null) {
                ...
                for (int i_18_ = 0;
                        ((aBooleanArray1742.length ^ 0xffffffff) < (i_18_ ^
                        0xffffffff)); i_18_++) {
                    if (anIntArray256[i_18_] > 0) {
                        Login.method313(i_18_, this, aClass69_1743, 1);
                        anInt1761 = i_18_;
                    }
                }
            ...
            try {
                ...
                if (class69 == aClass69_1737) {
                    ...
                    if (is == null) {
                        ...
                        if ((i_22_ != 5) && (i_22_ != 6)) {
                            throw new RuntimeException(
                                "Incorrect JS5 protocol number: " + i_22_);
                        }
                    ...
                    if ((is == null) || (is.length <= 2)) {
                        ...
                        if (aBoolean1750 || bool) {
                            Class17.method184(bool, i, anIntArray277[i],
                                -1350430544, this, (byte) 2, anInt1747);
                        }
                    } else {
                        aCRC32_1741.reset();
                        ...
                        int i_25_ = (((is[is.length + -2] << 966560136) &
                            0xff00) - -(is[is.length - 1] & 0xff));
                        ...
                        if ((i_24_ != anIntArray277[i]) ||
                            ...
                            anObjectArray278[i] = Class88.method1332(false, is,
                                    (byte) 2);
                        }
                    }
                }
