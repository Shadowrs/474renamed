...
public class Class37_Sub20 extends Class37 {
    ...
    public SignlinkResourceNode[] aClass23Array2206;
    public int anInt2207;
    public SignlinkResourceNode[] aClass23Array2209;
    ...
    public static void method1022(int i, int i_13_, int i_14_, int i_15_) {
        ...
        if (i > 0) {
            for (int i_18_ = 1; i_18_ < 8; i_18_++)
                Class64.anIntArrayArrayArray1217[i_15_][i][i_14_ + i_18_] = (Class64.anIntArrayArrayArray1217[i_15_][i +
                    -1][i_18_ + i_14_]);
        }

        if (i_14_ > 0) {
            for (int i_19_ = 1; (i_19_ ^ 0xffffffff) > -9; i_19_++)
                Class64.anIntArrayArrayArray1217[i_15_][i + i_19_][i_14_] = (Class64.anIntArrayArrayArray1217[i_15_][i +
                    i_19_][i_14_ + -1]);
        }
        ...
        if ((i > 0) &&
                ...
                0xffffffff) != -1)) {
            Class64.anIntArrayArrayArray1217[i_15_][i][i_14_] = Class64.anIntArrayArrayArray1217[i_15_][-1 +
                i][i_14_];
        } else if ((i_14_ <= 0) ||
                ((Class64.anIntArrayArrayArray1217[i_15_][i][i_14_ + -1] ^
                0xffffffff) == -1)) {
            if (((i ^ 0xffffffff) < -1) && ((i_14_ ^ 0xffffffff) < -1) &&
                    (Class64.anIntArrayArrayArray1217[i_15_][-1 + i][i_14_ - 1] != 0)) {
                Class64.anIntArrayArrayArray1217[i_15_][i][i_14_] = (Class64.anIntArrayArrayArray1217[i_15_][-1 +
                    i][i_14_ + -1]);
            }
        } else {
            Class64.anIntArrayArrayArray1217[i_15_][i][i_14_] = Class64.anIntArrayArrayArray1217[i_15_][i][-1 +
                i_14_];
        }
    }
