...
public class Class37_Sub4_Sub12 extends Class37_Sub4 {
    ...
    public static Class18 aClass18_2773 = null;
    ...
    public static JString aJString_2786;
    public static JString aJString_2787;
    ...
    static {
        ...
        anInt2784 = 0;
        anInt2783 = 0;
        aJString_2787 = Class37_Sub2.method332((byte) 102, "Password: ");
        aJString_2786 = aJString_2787;
    }
    ...
    public Class37_Sub4_Sub7_Sub6 method694(int i, int i_0_, int i_1_,
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6) {
        i = anIntArray2761[i];

        Class37_Sub4_Sub16 class37_sub4_sub16 = Class45.method1097((byte) 127,
                i >> 494083856);
        i &= 0xffff;
        anInt2771++;
        ...
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_2_ = class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                    false, i));
    ...
    public Class37_Sub4_Sub7_Sub6 method695(
        ...
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_3_ = class37_sub4_sub7_sub6.method542(!class37_sub4_sub16.method722(
                    false, i));
    ...
    public void method696(Stream stream, int i) {
        for (;;) {
            int i_4_ = stream.method978(121);

            if ((i_4_ ^ 0xffffffff) == -1) {
                break;
            }

            method700(i_4_, stream, 11);
        }
    ...
    public static Class37_Sub4_Sub3 method697(int i, byte i_5_) {
        ...
        Class37_Sub4_Sub3 class37_sub4_sub3 = ((Class37_Sub4_Sub3) Class82.aClass65_1713.method1181((byte) 52,
                (long) i));
        ...
        if (is != null) {
            class37_sub4_sub3.method462(true, new Stream(is), i);
        }

        class37_sub4_sub3.method468(false);
        Class82.aClass65_1713.method1179((long) i, i_5_ + 88, class37_sub4_sub3);
    ...
    public static Class37_Sub4_Sub9_Sub1[] method698(int i) {
        ...
        Class37_Sub4_Sub9_Sub1[] class37_sub4_sub9_sub1s = new Class37_Sub4_Sub9_Sub1[Class10.anInt194];

        for (int i_6_ = 0;
                (Class10.anInt194 ^ 0xffffffff) < (i_6_ ^ 0xffffffff);
                i_6_++) {
            ...
            class37_sub4_sub9_sub1.anInt3861 = Class37_Sub9_Sub23.anIntArray3357[i_6_];
            class37_sub4_sub9_sub1.anInt3865 = Class14.anIntArray250[i_6_];

            class37_sub4_sub9_sub1.anInt3862 = Class37_Sub9_Sub28.anIntArray3434[i_6_];

            class37_sub4_sub9_sub1.anIntArray3859 = Class37_Sub9_Sub1.anIntArray2919;

            class37_sub4_sub9_sub1.aByteArray3860 = Class10.aByteArrayArray198[i_6_];
    ...
    public void method700(int i, Stream stream, int i_7_) {
        if (i != 1) {
            if (i == 2) {
                anInt2777 = stream.method980(55);
            } else if ((i ^ 0xffffffff) != -4) {
                if ((i ^ 0xffffffff) != -5) {
                    if ((i ^ 0xffffffff) == -6) {
                        anInt2762 = stream.method978(i_7_ ^ 0x7d);
                    } else if (i == 6) {
                        anInt2769 = stream.method980(50);
                    } else if (i == 7) {
                        anInt2758 = stream.method980(-123);
                    } else if (i == 8) {
                        anInt2776 = stream.method978(126);
                    } else if (i == 9) {
                        anInt2766 = stream.method978(121);
                    } else if (i != 10) {
                        if (i == 11) {
                            anInt2760 = stream.method978(i_7_ + 114);
                        } else if (i != 12) {
                            if ((i ^ 0xffffffff) == -14) {
                            ...
                            for (int i_11_ = 0; i_11_ < i_10_; i_11_++)
                                anIntArray2756[i_11_] = stream.method980(-126);

                            for (int i_12_ = 0;
                                    (i_12_ ^ 0xffffffff) > (i_10_ ^ 0xffffffff);
                                    i_12_++)
                                anIntArray2756[i_12_] = (stream.method980(-122) << -611978128) -
                                    -anIntArray2756[i_12_];
                        }
                    } else {
                        anInt2754 = stream.method978(i_7_ + 109);
                    }
                } else {
                    aBoolean2755 = true;
                }
            } else {
                int i_13_ = stream.method978(125);
                anIntArray2774 = new int[1 + i_13_];

                for (int i_14_ = 0;
                        (i_13_ ^ 0xffffffff) < (i_14_ ^ 0xffffffff); i_14_++)
                    anIntArray2774[i_14_] = stream.method978(118);

                anIntArray2774[i_13_] = 9999999;
            }
        } else {
            int i_15_ = stream.method980(i_7_ + -137);
            anIntArray2780 = new int[i_15_];

            for (int i_16_ = 0; (i_16_ ^ 0xffffffff) > (i_15_ ^ 0xffffffff);
                    i_16_++)
                anIntArray2780[i_16_] = stream.method980(21);

            anIntArray2761 = new int[i_15_];

            for (int i_17_ = 0; (i_17_ ^ 0xffffffff) > (i_15_ ^ 0xffffffff);
                    i_17_++)
                anIntArray2761[i_17_] = stream.method980(-123);

            for (int i_18_ = 0; i_15_ > i_18_; i_18_++)
                anIntArray2761[i_18_] = ((stream.method980(-119) << 1524262960) +
    ...
    public Class37_Sub4_Sub7_Sub6 method701(int i,
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6, byte i_19_,
        ...
        try {
            ...
            Class37_Sub4_Sub16 class37_sub4_sub16_23_ = Class45.method1097((byte) 127,
                    i_21_ >> 1605854416);
            i_21_ &= 0xffff;

            if (class37_sub4_sub16_23_ == null) {
                Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_24_ = class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                            false, i));
            ...
            Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_25_ = (class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                        false, i) &
                    !class37_sub4_sub16_23_.method722(false, i_21_)));
            class37_sub4_sub7_sub6_25_.method551(class37_sub4_sub16, i,
                class37_sub4_sub16_23_, i_21_, anIntArray2774);
    ...
    public Class37_Sub4_Sub7_Sub6 method702(int i,
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6, int i_26_) {
        ...
        if ((anIntArray2756 != null) &&
            ...
            class37_sub4_sub16_29_ = Class45.method1097((byte) 127,
                    i_28_ >> -1066659472);
            i_28_ &= 0xffff;
        }

        if ((class37_sub4_sub16_29_ == null) ||
                ((i_28_ ^ 0xffffffff) == -65536)) {
            Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_30_ = class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                        false, i_27_));
        ...
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_31_ = (class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                    false, i_27_) &
    ...
    public Class37_Sub4_Sub7_Sub6 method704(
        ...
        Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6_33_ = class37_sub4_sub7_sub6.method559(!class37_sub4_sub16.method722(
                    false, i));
