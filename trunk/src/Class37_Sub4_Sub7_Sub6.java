...
public abstract class Class37_Sub4_Sub7_Sub6 extends Class37_Sub4_Sub7 {
    ...
    public void method546(int i) {
        ...
        for (int i_11_ = 0; i_11_ < anInt3830; i_11_++) {
            int i_12_ = (((anIntArray3833[i_11_] * i_10_) -
                (anIntArray3824[i_11_] * i_9_)) >> 16);

            anIntArray3824[i_11_] = (((anIntArray3833[i_11_] * i_9_) +
                (anIntArray3824[i_11_] * i_10_)) >> 16);
    ...
    public abstract void method547(Class37_Sub4_Sub16 class37_sub4_sub16, int i);

    public abstract Class37_Sub4_Sub7_Sub6 method548(int[][] is, int i,
        int i_13_, int i_14_, boolean bool, int i_15_);
    ...
    public abstract void method551(Class37_Sub4_Sub16 class37_sub4_sub16,
        int i, Class37_Sub4_Sub16 class37_sub4_sub16_21_, int i_22_, int[] is);
    ...
    public void method555() {
        if (anInt3829 != 1) {
            ...
            anInt3831 = (int) (Math.sqrt((double) ((anInt3835 * anInt3835) +
                    (anInt2627 * anInt2627))) + 0.99);
            anInt3826 = (anInt3831 +
                (int) (Math.sqrt((double) ((anInt3835 * anInt3835) +
                    (anInt3834 * anInt3834))) + 0.99));
        }
    }
