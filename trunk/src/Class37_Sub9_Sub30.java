...
public class Class37_Sub9_Sub30 extends Class37_Sub9 {
    public static JString aJString_3462;
    public static int anInt3463;
    public static JString aJString_3466 = Class37_Sub2.method332((byte) 102,
            "Neuer Benutzer");
    public static int anInt3467;
    public static int anInt3469;
    public static int anInt3471;
    public static JString aJString_3472;
    public static int anInt3473;
    public static int anInt3474;
    public static int[] anIntArray3475;
    public static JString aJString_3476 = Class37_Sub2.method332((byte) 108,
            "Stufe)2");
    ...
    static {
        aJString_3472 = Class37_Sub2.method332((byte) 112, "Bad session id)3");
        aJString_3462 = aJString_3472;
        anInt3480 = 0;
        anInt3479 = 0;
...
while_107_: 
    ...
    public boolean method892(int i, int i_1_, int i_2_) {
        ...
        int i_4_ = (Class37_Sub4_Sub7_Sub2.anIntArray3711[(0xffc60 &
            (255 * i_3_)) >> -2095906900]);
    ...
    public boolean method893(byte i, int i_5_, int i_6_) {
        ...
        int i_8_ = (Class37_Sub4_Sub7_Sub2.anIntArray3711[(0xffa81 &
            (255 * i_7_)) >> 147130988]);
    ...
    public int[] method761(int i, int i_9_) {
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_11_ = 0;
                ...
                is[i_11_] = (!method892(107, i_13_, i_15_) &&
    ...
    public static void method895(int i, long l) {
        try {
            ...
            if ((l ^ 0xffffffffffffffffL) != -1L) {
                ...
                for (int i_18_ = 0;
                        (i_18_ ^ 0xffffffff) > (Class18.anInt340 ^ 0xffffffff);
                        i_18_++) {
                    if ((Class80.aLongArray1504[i_18_] ^ 0xffffffffffffffffL) == (l ^
                            0xffffffffffffffffL)) {
                        ...
                        for (int i_19_ = i_18_;
                                ...
                                0xffffffff)); i_19_++) {
                            Class80.aLongArray1504[i_19_] = Class80.aLongArray1504[i_19_ -
                                -1];

                            Class18.aJStringArray332[i_19_] = Class18.aJStringArray332[1 +
                                i_19_];
                        }
