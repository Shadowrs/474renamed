...
public class Class30 {
    ...
    public static JString aJString_721 = Class37_Sub2.method332((byte) 102,
            "(U4");
    public static int anInt722;
    public static int anInt723;
    public static int anInt725;
    public static JString aJString_726 = Class37_Sub2.method332((byte) 109,
            " )2>");
    public int anInt720;
    public int anInt724;
    ...
    public Class30(int i, int i_18_) {
        if ((i_18_ ^ 0xffffffff) != (i ^ 0xffffffff)) {
            ...
            for (int i_20_ = 0; i_20_ < i; i_20_++) {
                ...
                for (; (i_22_ ^ 0xffffffff) < (i_21_ ^ 0xffffffff); i_21_++) {
                    double d_24_ = d_23_;
                    ...
                    d_24_ *= (0.54 +
                    (0.46 * Math.cos(((double) i_21_ - d) * 0.2243994752564138)));
    ...
    public byte[] method275(int i, byte[] is) {
        ...
        if (anIntArrayArray727 != null) {
            int i_3_ = ((int) (((long) is.length * (long) anInt720) / (long) anInt724) +
                14);
    ...
    public static Class37_Sub4_Sub9_Sub1 method277(JString jstring, int i,
        ...
        try {
            ...
            int i_16_ = class15.method123((byte) 32, jstring_15_);
            int i_17_ = class15.method128(jstring, -97, i_16_);
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("ic.D(" + ((jstring != null) ? "{...}" : "null") + ',' + i +
                ',' + ((jstring_15_ != null) ? "{...}" : "null") + ',' +
                ((class15 != null) ? "{...}" : "null") + ')'));
        }
    }
}
