...
public class Class71 {
    ...
    public static JString aJString_1358;
    public static JString aJString_1359;
    ...
    public static JString aJString_1369;

    static {
        aLongArray1360 = new long[200];
        aJString_1359 = Class37_Sub2.method332((byte) 125, "_");
        anIntArray1364 = new int[100];
        anInt1356 = 0;
        aJString_1358 = Class37_Sub2.method332((byte) 110, "Continue");

        aJString_1365 = (Class37_Sub2.method332((byte) 124,
                "Die Adresse dieses Computers wurde gesperrt)1"));
        aJString_1369 = aJString_1358;
    }
            ...
            if ((class37_sub2.anInt1828 ^ 0xffffffff) == -1) {
                if (((class37_sub2.anInt1830 ^ 0xffffffff) > -1) ||
                    ...
                    Class37_Sub9_Sub16.method828(class37_sub2.anInt1827,
                        class37_sub2.anInt1830, 126, class37_sub2.anInt1815,
                        class37_sub2.anInt1829, class37_sub2.anInt1813,
                        class37_sub2.anInt1834, class37_sub2.anInt1836);
                ...
                if ((class37_sub2.anInt1816 == 0) &&
                        ...
                        ((class37_sub2.anInt1837 < 0) ||
                        Class37_Sub9_Sub2.method767(class37_sub2.anInt1823,
                            (byte) 1, (class37_sub2.anInt1837)))) {
                    Class37_Sub9_Sub16.method828(class37_sub2.anInt1823,
                        class37_sub2.anInt1837, 106, class37_sub2.anInt1815,
                        class37_sub2.anInt1829, class37_sub2.anInt1813,
                        class37_sub2.anInt1833, class37_sub2.anInt1836);
                    class37_sub2.anInt1816 = -1;

                    if ((class37_sub2.anInt1837 == class37_sub2.anInt1830) &&
                            ((class37_sub2.anInt1830 ^ 0xffffffff) == 0)) {
                        class37_sub2.method322(false);
                    } else if (((class37_sub2.anInt1837 ^ 0xffffffff) == (class37_sub2.anInt1830 ^
                            0xffffffff)) &&
                            ((class37_sub2.anInt1833 ^ 0xffffffff) == (class37_sub2.anInt1834 ^
                            0xffffffff)) &&
    ...
    public static void method1266(int i) {
        ...
        Class37_Sub4_Sub9.method595(i_3_ - -1, 18 + i_5_, -2 + i_4_,
            -19 + i_7_, 0);
        Class37_Sub4_Sub7_Sub2.aClass37_Sub4_Sub9_Sub2_Sub1_3724.method607(Class37_Sub9_Sub28.aJString_3439,
            3 + i_3_, i_5_ + 14, i_6_, -1);
        ...
        for (int i_10_ = 0; i_10_ < Class37_Sub9_Sub13.anInt3134; i_10_++) {
            ...
            Class37_Sub4_Sub7_Sub2.aClass37_Sub4_Sub9_Sub2_Sub1_3724.method607(Class37_Sub4_Sub7_Sub1_Sub2.method510(
                    i_10_, 52), 3 + i_3_, i_11_, i_12_, 0);
        }
