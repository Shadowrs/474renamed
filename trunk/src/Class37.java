...
public class Class37 {
    ...
    public static void method324(int i, int i_0_,
        Class37_Sub4_Sub7_Sub1_Sub2 class37_sub4_sub7_sub1_sub2, int i_1_) {
        if (i_1_ != 0) {
            anInt820 = 19;
        }

        if (((class37_sub4_sub7_sub1_sub2.anInt3655 ^ 0xffffffff) == (i_0_ ^
                0xffffffff)) && ((i_0_ ^ 0xffffffff) != 0)) {
            ...
            if ((i_2_ ^ 0xffffffff) == -3) {
                ...
                (((Class37_Sub9_Sub22.method861(i_1_ ^ ~0x5, i_0_).anInt2762) ^
                0xffffffff) <= ((Class37_Sub9_Sub22.method861(-48,
                    class37_sub4_sub7_sub1_sub2.anInt3655).anInt2762) ^
                0xffffffff))) {
            class37_sub4_sub7_sub1_sub2.anInt3680 = 0;

            class37_sub4_sub7_sub1_sub2.anInt3640 = class37_sub4_sub7_sub1_sub2.anInt3645;
            class37_sub4_sub7_sub1_sub2.anInt3677 = 0;
            class37_sub4_sub7_sub1_sub2.anInt3689 = i;
