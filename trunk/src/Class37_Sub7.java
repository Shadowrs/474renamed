...
public class Class37_Sub7 extends Class37 {
    ...
    public static void method740(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        int i_4_ = 0;

        if (i_3_ == 16711680) {
            for (; i_4_ < Class37_Sub9_Sub37.anInt3597; i_4_++) {
                if ((((PacketStream.anIntArray3611[i_4_] +
                        Class71.anIntArray1364[i_4_]) ^ 0xffffffff) < (i_0_ ^
                        0xffffffff)) &&
                        ((i + i_0_) > Class71.anIntArray1364[i_4_]) &&
                        ((i_1_ ^ 0xffffffff) > ((Class43.anIntArray961[i_4_] -
    ...
    public static void method741(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
        ...
        if (Class64.aBoolean1216) {
            ...
            int i_11_ = 20 + i_5_;
            Class17.aClass37_Sub4_Sub9_Sub2_Sub1_315.method603((Class37_Sub9_Sub27.method881(
                    -120,
                    (new JString[] {
                        Class21.aJString_561,
            ...
            Class17.aClass37_Sub4_Sub9_Sub2_Sub1_315.method603((Class37_Sub9_Sub27.method881(
                    -93,
                    new JString[] {
                        Class37_Sub9_Sub29.aJString_3444,
                        Class37_Sub9_Sub24.method870(i_12_, (byte) -114),
                        Class37_Sub9_Sub10.aJString_3087
                    })), i_10_, i_11_, i_13_, -1);
            i_11_ += 15;
        }
    }
    ...
    public static void method742(boolean bool, int i) {
        ...
        Class37_Sub13 class37_sub13 = ((Class37_Sub13) Class37_Sub4_Sub7_Sub1.aClass13_3670.method100((byte) 77,
                (long) i));
        anInt1919++;
    ...
    public void method744(int i) {
        ...
        ObjectDef objectdef = aObjectDef_1901.method681((byte) 95);
        ...
        if (objectdef == null) {
            ...
            anIntArray1895 = objectdef.anIntArray2714;
            anInt1905 = objectdef.soundRange * 128;
            anInt1910 = objectdef.soundId;
            anInt1908 = objectdef.anInt2727;
            anInt1909 = objectdef.anInt2692;
        }
