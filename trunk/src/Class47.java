...
public class Class47 implements Runnable {
    ...
    public static Class18 aClass18_995;
    public static JString aJString_998 = Class37_Sub2.method332((byte) 118,
            "sl_arrows");
    ...
    public static void method1109(int i,
        ...
        for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > -21; i_4_++) {
            for (int i_5_ = 1;
                    (i_5_ ^ 0xffffffff) > ((-1 + i_1_) ^ 0xffffffff); i_5_++) {
                for (int i_6_ = 1; i_6_ < 127; i_6_++) {
                    int i_7_ = (i_5_ << -486475673) + i_6_;

                    Class37_Sub9_Sub16.anIntArray3199[i_7_] = ((Class27.anIntArray677[1 +
                        i_7_] +
            ...
            for (int i_9_ = 0; i_9_ < class37_sub4_sub9_sub1.anInt3862;
                ...
                for (int i_10_ = 0; i_10_ < class37_sub4_sub9_sub1.anInt3865;
                    ...
                    if (class37_sub4_sub9_sub1.aByteArray3860[i_8_++] != 0) {
                        int i_11_ = class37_sub4_sub9_sub1.anInt3863 +
                            (i_10_ + 16);
                        int i_12_ = (i_9_ + 16) -
