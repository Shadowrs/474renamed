...
public class Class37_Sub9_Sub36 extends Class37_Sub9 {
    ...
    public static void method916(int i, int i_0_, Class20[] class20s,
        byte[] is, int i_1_, int i_2_, int i_3_, int i_4_, int i_5_, byte i_6_) {
        try {
            anInt3570++;
            for (int i_7_ = 0; (i_7_ ^ 0xffffffff) > -9; i_7_++) {
                for (int i_8_ = 0; (i_8_ ^ 0xffffffff) > -9; i_8_++) {
                    if (((i_1_ - -i_7_) > 0) && ((i_7_ + i_1_) < 103) &&
                        ...
                        i_2_] = Class37_Sub4_Sub7.method490((class20s[i_5_].anIntArrayArray554[i_7_ +
                                i_1_][i_8_ + i_2_]), -16777217);
                    }
                }
            }
                ...
                for (int i_11_ = 0; i_11_ < 64; i_11_++) {
                    for (int i_12_ = 0; (i_12_ ^ 0xffffffff) > -65; i_12_++) {
                        if (((i_10_ ^ 0xffffffff) == (i_3_ ^ 0xffffffff)) &&
                                ...
                                ((i_0_ - -8) > i_12_)) {
                            Class87.method1325(0, 0, i_4_,
                                i_1_ -
                                -Class37.method325(0x7 & i_11_, 104, i_4_,
                                    i_12_ & 0x7), i_5_, -9890, stream,
                                Class71.method1260(i_4_, 100, 0x7 & i_11_,
                                    i_12_ & 0x7) + i_2_);
                        } else {
    ...
    public static Class37_Sub4_Sub4 method918(int i, int i_13_) {
        ...
        Class37_Sub4_Sub4 class37_sub4_sub4 = ((Class37_Sub4_Sub4) Client.aClass65_1728.method1181((byte) 80,
                (long) i_13_));
        ...
        if (is != null) {
            class37_sub4_sub4.method473(new Stream(is), (byte) -46);
        }
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_16_ = 0; i_16_ < AbstractDrawingArea.anInt743; i_16_++) {
                ...
                is[i_16_] = ((((i_17_ ^ 0xffffffff) <= (anInt3583 ^ 0xffffffff)) &&
                    ((anInt3582 ^ 0xffffffff) <= (i_17_ ^ 0xffffffff))) ? 4096 : 0);
            }
        }
    ...
    public static int method919(int i, int i_18_, int i_19_) {
        ...
        Class37_Sub13 class37_sub13 = ((Class37_Sub13) Class37_Sub4_Sub7_Sub1.aClass13_3670.method100((byte) 87,
                (long) i_18_));
    ...
    public static void method920(int i, JS5 class15, JS5 class15_20_,
        ...
        try {
            ...
            Stream.aClass15_2025 = class15_22_;
            Class80.aClass15_1507 = class15_20_;

            Class37_Sub9_Sub29.aClass18ArrayArray3454 = (new Class18[Class37_Sub4_Sub14.aClass15_2805.method108((byte) 93)][]);

            if (i == -23499) {
                Class15_Sub1.aBooleanArray1754 = new boolean[Class37_Sub4_Sub14.aClass15_2805.method108((byte) 64)];
            }
        } catch (RuntimeException runtimeexception) {
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("vf.B(" + i + ',' + ((class15 != null) ? "{...}" : "null") +
        ...
        if (bool == true) {
            ...
            do {
                if ((i_23_ ^ 0xffffffff) != -1) {
                    ...
                    anInt3583 = stream.readShort();

                    break;
                }

                anInt3582 = stream.readShort();
            } while (false);
        }
    }
}
