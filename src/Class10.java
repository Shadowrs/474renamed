...
public class Class10 {
    ...
    public static int method83(int i, int i_0_, int i_1_, int i_2_) {
        ...
        int i_7_ = Class37_Sub4.method431(i_5_, (byte) 25, i_3_);
        int i_8_ = Class37_Sub4.method431(i_5_, (byte) -115, i_3_ + 1);
        int i_9_ = Class37_Sub4.method431(1 + i_5_, (byte) 125, i_3_);
        int i_10_ = Class37_Sub4.method431(i_5_ - -1, (byte) 94, 1 + i_3_);
