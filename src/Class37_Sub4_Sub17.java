        ...
        for (;;) {
            ...
            for (int i_3_ = 0; class37_sub20.anInt2205 > i_3_; i_3_++) {
                if (class37_sub20.anIntArray2212[i_3_] != 0) {
                    stream_sub1.writeByte(class37_sub20.anIntArray2212[i_3_]);
                } else {
                    try {
                        ...
                        stream_sub1.writeByte(-10);
                    } catch (java.io.InvalidClassException invalidclassexception) {
                        stream_sub1.writeByte(-11);
                    } catch (java.io.StreamCorruptedException streamcorruptedexception) {
                        stream_sub1.writeByte(-12);
                    } catch (java.io.OptionalDataException optionaldataexception) {
                        stream_sub1.writeByte(-13);
                    } catch (IllegalAccessException illegalaccessexception) {
                        stream_sub1.writeByte(-14);
                    } catch (IllegalArgumentException illegalargumentexception) {
                        stream_sub1.writeByte(-15);
                    } catch (java.lang.reflect.InvocationTargetException invocationtargetexception) {
                        stream_sub1.writeByte(-16);
                    } catch (SecurityException securityexception) {
                        stream_sub1.writeByte(-17);
                    } catch (java.io.IOException ioexception) {
                        stream_sub1.writeByte(-18);
                    } catch (NullPointerException nullpointerexception) {
                        stream_sub1.writeByte(-19);
                    } catch (Exception exception) {
                        stream_sub1.writeByte(-20);
                    } catch (Throwable throwable) {
                        stream_sub1.writeByte(-21);
                    }
                }
            }
