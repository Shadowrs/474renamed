...
public class Class37_Sub9_Sub33 extends Class37_Sub9 {
    ...
    public static JString aJString_3520;
    public static JString aJString_3521;
    ...
    public static SignlinkResourceNode aClass23_3527;
    ...
    public static void method901(Class69 class69, int i,
        ...
        try {
            ...
            synchronized (Class37_Sub9_Sub34.aClass58_3557) {
                for (Class37_Sub5 class37_sub5 = ((Class37_Sub5) Class37_Sub9_Sub34.aClass58_3557.method1155(
                            0)); class37_sub5 != null;
                        class37_sub5 = (Class37_Sub5) Class37_Sub9_Sub34.aClass58_3557.method1162(
                                (byte) 54)) {
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("uh.C(" + ((class69 != null) ? "{...}" : "null") + ',' + i +
                ',' + ((class15_sub1 != null) ? "{...}" : "null") + ',' + bool +
                ')'));
        }
    }
    ...
    public static void method905(int i) {
        for (int i_11_ = -1;
            ...
            Class37_Sub4_Sub7_Sub1_Sub2 class37_sub4_sub7_sub1_sub2 = Class75.aClass37_Sub4_Sub7_Sub1_Sub2Array1414[i_12_];

            if (class37_sub4_sub7_sub1_sub2 != null) {
                Class37_Sub9_Sub3.method771(1, class37_sub4_sub7_sub1_sub2, 105);
            }
        }
