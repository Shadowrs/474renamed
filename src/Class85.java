...
public class Class85 {
	...
	public static int method1319(byte[] is, int i, int i_0_, int i_1_) {
		...
		for (int i_3_ = i; i_3_ < i_0_; i_3_++)
			i_2_ = (Class37_Sub1.anIntArray1803[0xff & (i_2_ ^ is[i_3_])] ^ i_2_ >>> 8);
	...
	public static void method1320(Class18 class18, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_) {
		anInt1540++;
		...
		if ((Class60.anInt1140 ^ 0xffffffff) != -1) {
			if ((i <= i_7_) && ((i_7_ ^ 0xffffffff) > ((16 + i) ^ 0xffffffff)) && (i_8_ <= i_9_) && ((i_9_ ^ 0xffffffff) > ((i_8_ + 16) ^ 0xffffffff))) {
				class18.anInt432 -= 4;
				Class73.method1274(class18, -1);
			} else if (((i_7_ ^ 0xffffffff) > (i ^ 0xffffffff)) || (((16 + i) ^ 0xffffffff) >= (i_7_ ^ 0xffffffff)) || (i_9_ < (-16 + (i_8_ - -i_5_))) || (((i_8_ - -i_5_) ^ 0xffffffff) >= (i_9_ ^ 0xffffffff))) {
				if (((-Class37_Sub16.anInt2154 + i) <= i_7_) && (i_7_ < (Class37_Sub16.anInt2154 + (16 + i))) && (((i_8_ - -16) ^ 0xffffffff) >= (i_9_ ^ 0xffffffff)) && ((-16 + (i_8_ + i_5_)) > i_9_)) {
					...
					class18.anInt432 = ((i_6_ + -i_5_) * i_12_) / i_13_;
					Class73.method1274(class18, -1);
		...
		if ((Class37_Sub4_Sub7_Sub1_Sub1.anInt3945 ^ 0xffffffff) != -1) {
			int i_14_ = class18.anInt441;

			if ((i_7_ >= (i - i_14_)) && ((i_8_ ^ 0xffffffff) >= (i_9_ ^ 0xffffffff)) && (i_7_ < (i - -16)) && (i_9_ <= (i_5_ + i_8_))) {
				class18.anInt432 += (Class37_Sub4_Sub7_Sub1_Sub1.anInt3945 * 45);
				Class73.method1274(class18, -1);
			}
		}
	}
	...
	public static void method1321(int i, int i_15_, byte i_16_) {
		if (i_16_ == 3) {
			...
			Class37_Sub4_Sub13 class37_sub4_sub13 = ((Class37_Sub4_Sub13) Class37_Sub4_Sub18.aClass13_2905.method100((byte) 58, l));
	...
	public static int method1322(int i, int i_17_, int i_18_, int i_19_, int i_20_) {
		int i_21_ = ((-Class37_Sub4_Sub9_Sub4.anIntArray3929[(1024 * i_19_) / i_18_] + 65536) >> -1009382879);
		...
		return (((i * i_21_) >> 2058356880) + (((65536 - i_21_) * i_20_) >> 448779536));
	}
}
