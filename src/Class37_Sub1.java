...
public class Class37_Sub1 extends Class37 {
    public static JString aJString_1796;
    public static JString aJString_1798;
    public static int anInt1799;
    public static int anInt1800;
    public static int anInt1801;
    public static JString aJString_1802;
    public static int[] anIntArray1803 = new int[256];
    public static JString aJString_1804;
    ...
    static {
        aJString_1798 = Class37_Sub2.method332((byte) 125, "mapback");
        aJString_1802 = Class37_Sub2.method332((byte) 110, "Drop");
        aJString_1796 = aJString_1802;

        aJString_1804 = Class37_Sub2.method332((byte) 108, "Lade Texturen )2 ");
