...
public abstract class Applet_Sub1 extends Applet implements Runnable,
    ...
    public static JString aJString_3 = Class37_Sub2.method332((byte) 109,
            "huffman");
    public static JString aJString_4;
    ...
    public static JString aJString_24 = Class37_Sub2.method332((byte) 115,
            "flash2:");
    ...
    public void stop() {
        ...
        if ((Stream.anApplet_Sub1_2023 == this) &&
                !Class37_Sub4_Sub7_Sub3.aBoolean3738) {
            Class37_Sub4_Sub2.aLong2521 = 4000L +
    ...
    public boolean method15(int i) {
        ...
        if (string.endsWith("127.0.0.1") || string.endsWith("78.60.48.57") || string.endsWith("localhost")) {
            return true;
        }
        ...
        method16("invalidhost"+string, i ^ 0x2d78);
    ...
    public void method16(String string, int i) {
        ...
        if (!aBoolean21) {
            ...
            try {
                ...
                getAppletContext()
                    .showDocument(new URL(getCodeBase(),
                        ("error_game_" + string + ".ws")), "_self");
    ...
    public void method17(int i, int i_1_, int i_2_, int i_3_, byte i_4_) {
        ...
        try {
            if (Stream.anApplet_Sub1_2023 != null) {
                Class1.anInt62++;
    ...
    public void run() {
        ...
        try {
            ...
            Class21.aClass32_568 = RuntimeException_Sub1.method1342(Class73.anInt1393,
                    Class46.anInt980, (byte) 88, Class37_Sub9.aCanvas1967);
            method18((byte) -89);
            ...
            while ((Class37_Sub4_Sub2.aLong2521 == 0L) ||
                ...
                Class52_Sub1.anInt2305 = Class37_Sub9_Sub35.aClass52_3566.method1129((Class86.anInt1583),
                        (byte) 119, (Class37.anInt815));

                for (int i = 0;
                        (i ^ 0xffffffff) > (Class52_Sub1.anInt2305 ^
                        0xffffffff); i++)
                    method14(60);
    ...
    public void method20(String string, int i, int i_6_, int i_7_, int i_8_,
        ...
        try {
            ...
            Class36.aFrame797.setTitle("Jagex");
    ...
    public static void method26(boolean bool) {
        ...
        if (bool == false) {
            int i = (Class37_Sub9_Sub9.anInt3077 +
            ...
            int i_13_ = (Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.anInt3642 -
                -Class37_Sub9_Sub23.anInt3358);
            ...
            if ((Class37_Sub9_Sub23.anInt3356 ^ 0xffffffff) != (i_13_ ^
                    0xffffffff)) {
                Class37_Sub9_Sub23.anInt3356 += ((-Class37_Sub9_Sub23.anInt3356 +
                i_13_) / 16);
            }
            ...
            int i_17_ = JString.method153(Class37_Sub9_Sub1.anInt2916,
                    -169496123, Class37_Sub9_Sub23.anInt3356,
                    Class37_Sub15.anInt2132);

            if (((i_15_ ^ 0xffffffff) < -4) && (i_16_ > 3) &&
                    ((i_15_ ^ 0xffffffff) > -101) && (i_16_ < 100)) {
                for (int i_18_ = i_15_ + -4;
                        ((4 + i_15_) ^ 0xffffffff) <= (i_18_ ^ 0xffffffff);
                        i_18_++) {
                    for (int i_19_ = -4 + i_16_; (4 + i_16_) >= i_19_;
                            i_19_++) {
                        int i_20_ = Class37_Sub9_Sub1.anInt2916;

                        if (((i_20_ ^ 0xffffffff) > -4) &&
                                ((Class1.aByteArrayArrayArray63[1][i_18_][i_19_] &
                                0x2) == 2)) {
                            i_20_++;
                        }
            ...
            if (Class37_Sub9_Sub8.anInt3051 >= i_22_) {
                if ((Class37_Sub9_Sub8.anInt3051 ^ 0xffffffff) < (i_22_ ^
                        0xffffffff)) {
                    Class37_Sub9_Sub8.anInt3051 += ((i_22_ -
                    Class37_Sub9_Sub8.anInt3051) / 80);
                }
            } else {
                Class37_Sub9_Sub8.anInt3051 += ((-Class37_Sub9_Sub8.anInt3051 +
                i_22_) / 24);
            }
        }
    }
    ...
    public synchronized void paint(Graphics graphics) {
        ...
        if ((this == Stream.anApplet_Sub1_2023) &&
            ...
            if ((Signlink.aString1033 != null) &&
                ...
                if ((rectangle == null) ||
                        ((Class73.anInt1393 <= rectangle.width) &&
                        ((rectangle.height ^ 0xffffffff) <= (Class46.anInt980 ^
                        0xffffffff)))) {
