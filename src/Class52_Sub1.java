...
public class Class52_Sub1 extends Class52 {
    ...
    public static JString aJString_2304 = (Class37_Sub2.method332((byte) 118,
    ...
    public static void method1131(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
        ...
        Class37_Sub13 class37_sub13 = ((Class37_Sub13) Class37_Sub4_Sub7_Sub1.aClass13_3670.method100((byte) 98,
                (long) i_1_));
        ...
        if (i_0_ >= class37_sub13.anIntArray2116.length) {
            ...
            for (int i_5_ = 0; class37_sub13.anIntArray2116.length > i_5_;
                    i_5_++) {
                is[i_5_] = class37_sub13.anIntArray2116[i_5_];
                is_4_[i_5_] = class37_sub13.anIntArray2108[i_5_];
            }

            for (int i_6_ = class37_sub13.anIntArray2116.length; i_6_ < i_0_;
                    i_6_++) {
                is[i_6_] = -1;
                is_4_[i_6_] = 0;
            }
    ...
    public int method1129(int i, byte i_7_, int i_8_) {
        ...
        if (aLongArray2302[anInt2300] == 0L) {
            ...
            anInt2293 = (int) ((long) (2560 * i_8_) / (-aLongArray2302[anInt2300] +
                aLong2295));
        }
        ...
        if (anInt2293 > 256) {
            ...
            anInt2297 = (int) ((long) i_8_ +
                -((-aLongArray2302[anInt2300] + aLong2295) / 10L));
        }
