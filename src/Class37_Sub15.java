...
public class Class37_Sub15 extends Class37 {
    ...
    public Class37_Sub15(byte[] is) {
        ...
        for (int i_63_ = 0; (i_63_ ^ 0xffffffff) > -129; i_63_++) {
            if (i_60_ == 0) {
                ...
                i_62_ = stream.method974((byte) -124);
            }

            aShortArray2147[i_63_] += Class37_Sub4_Sub7.method490((i_62_ - 1) << 874813454,
                32768);
            i_60_--;
        ...
        for (int i_67_ = 0; i_67_ < 128; i_67_++) {
            if ((anIntArray2146[i_67_] ^ 0xffffffff) != -1) {
                if ((i_60_ ^ 0xffffffff) == -1) {
                    ...
                    i_66_ = ((stream.buffer[i_40_++] - -16) << 2016629890);
                }
        ...
        if (is_52_ != null) {
            ...
            for (int i_86_ = 0; i_85_ > i_86_; i_86_++)
                aByteArray2144[i_86_] = (byte) ((32 +
                    (i_84_ * aByteArray2144[i_86_])) >> 203301030);
            ...
            while ((is_52_.length ^ 0xffffffff) < (i_87_ ^ 0xffffffff)) {
                ...
                int i_90_ = ((-i_85_ + i_88_) * i_84_) -
                    -((-i_85_ + i_88_) / 2);

                for (int i_91_ = i_85_;
                        (i_88_ ^ 0xffffffff) < (i_91_ ^ 0xffffffff); i_91_++) {
                    int i_92_ = Class77.method1287(256, -i_85_ + i_88_, i_90_);
                    i_90_ += (i_89_ + -i_84_);

                    aByteArray2144[i_91_] = (byte) (((aByteArray2144[i_91_] * i_92_) -
                        -32) >> -2000761882);
                }
            ...
            for (int i_93_ = i_85_; i_93_ < 128; i_93_++)
                aByteArray2144[i_93_] = (byte) ((32 +
                    (aByteArray2144[i_93_] * i_84_)) >> 2084994022);
        ...
        if (is_55_ != null) {
            ...
            for (int i_97_ = 0; (i_97_ ^ 0xffffffff) > (i_96_ ^ 0xffffffff);
                    i_97_++) {
            ...
            while (i_99_ < is_55_.length) {
                ...
                for (int i_103_ = i_96_; i_103_ < i_100_; i_103_++) {
                    int i_104_ = Class77.method1287(256, -i_96_ + i_100_, i_102_);
        ...
        for (int i_114_ = 0; (i_45_ ^ 0xffffffff) < (i_114_ ^ 0xffffffff);
                i_114_++) {
                    ...
                    if (i_3_ != 0) {
                        if (i_1_ != i_3_) {
                            ...
                            if (((--i_3_ & 0x1) ^ 0xffffffff) == -1) {
                                class37_sub22_sub1 = class73.method1277(i_3_ >> -606188094,
                                        is_0_, (byte) 111);
                            } else {
    ...
    public static void method1008(int i, int i_5_, int i_6_, int i_7_, int i_8_) {
        ...
        if (!Class37_Sub4_Sub12.aBoolean2775) {
            ...
            if ((i_10_ ^ 0xffffffff) > ((Class37_Sub9_Sub8.anInt3051 / 256) ^
                    0xffffffff)) {
            ...
            Class37_Sub9_Sub22.method858(52, (i_10_ * 3) + 600, anInt2132,
        ...
        for (int i_17_ = 0; (i_17_ ^ 0xffffffff) > -6; i_17_++) {
            if (Class37_Sub9_Sub30.aBooleanArray3477[i_17_]) {
                int i_18_ = (int) ((Math.random() * (double) (1 +
                    (2 * (Class37_Sub9_Sub4.anIntArray2982[i_17_])))) -
                    (double) Class37_Sub9_Sub4.anIntArray2982[i_17_] +
        ...
        if (((i_20_ ^ 0xffffffff) > (i_8_ ^ 0xffffffff)) ||
                ((i_8_ + i_6_) <= i_20_) ||
        ...
        ((Class82) Class37_Sub4_Sub9_Sub4.anInterface3_3926).method1306(Class37_Sub9_Sub37.anInt3589,
            false);
        ...
        if (Class10.aBoolean197) {
            Class37_Sub4_Sub9.method578(i_8_, i_7_, i_6_, i, 0);
            Class79.method1298(Class37_Sub4_Sub18.aJString_2908, false,
                i_5_ + -4441);
        }
        ...
        try {
            ...
            if (!Class79.aBoolean1488) {
                ...
                byte[] is = class15_21_.method126((byte) 108,
                        Class37_Sub9_Sub21.aJString_3312,
                        Class37_Sub9_Sub33.aJString_3524);

                if (i == -3473) {
                    Class42.aClass37_Sub4_Sub9_Sub3_923 = new Class37_Sub4_Sub9_Sub3(is,
                            component);

                    Class14.aClass37_Sub4_Sub9_Sub3_238 = Class42.aClass37_Sub4_Sub9_Sub3_923.method648();

                    Class37_Sub9_Sub21.aClass37_Sub4_Sub9_Sub1_3320 = Class30.method277(Class37_Sub9_Sub33.aJString_3524,
                    ...
                    Class37_Sub4_Sub7_Sub7.aClass37_Sub4_Sub9_Sub1Array3853 = Class46.method1104(class15,
                            ...
                            Class37_Sub9_Sub21.aJString_3319);
                    ...
                    for (int i_23_ = 0; i_23_ < 64; i_23_++)
                        Class37_Sub9_Sub28.anIntArray3428[64 + i_23_] = 16711680 -
                            -(i_23_ * 1024);

                    for (int i_24_ = 0; (i_24_ ^ 0xffffffff) > -65; i_24_++)
                        Class37_Sub9_Sub28.anIntArray3428[i_24_ - -128] = (4 * i_24_) +
                            16776960;
                    ...
                    for (int i_27_ = 0; i_27_ < 64; i_27_++)
                        Class37_Sub9.anIntArray1951[i_27_ + 64] = (i_27_ * 4) +
                            65280;

                    for (int i_28_ = 0; i_28_ < 64; i_28_++)
                        Class37_Sub9.anIntArray1951[i_28_ - -128] = 65535 -
                            -(i_28_ * 262144);
                    ...
                    for (int i_31_ = 0; (i_31_ ^ 0xffffffff) > -65; i_31_++)
                        Class37_Sub9_Sub33.anIntArray3519[i_31_ - -64] = 255 +
                            (262144 * i_31_);

                    for (int i_32_ = 0; (i_32_ ^ 0xffffffff) > -65; i_32_++)
                        Class37_Sub9_Sub33.anIntArray3519[i_32_ + 128] = (i_32_ * 1024) +
                            16711935;
                    ...
                    if (Class52.aBoolean1050) {
                        ...
                        Class41.method1074(Class54.aClass15_Sub1_1060, 2,
                            false, Class37_Sub9_Sub33.aJString_3524,
                            ItemDef.aJString_2508, 32, 255);
                    }

                    Class37_Sub4.method437(i ^ ~0xd07, false);
                    ...
                    Class56.aClass37_Sub4_Sub9_Sub3_1095 = new Class37_Sub4_Sub9_Sub3(128,
                            254);

                    Class64.aClass37_Sub4_Sub9_Sub3_1212 = new Class37_Sub4_Sub9_Sub3(128,
                            254);
                }
            }
        } catch (RuntimeException runtimeexception) {
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("nc.C(" + ((class15 != null) ? "{...}" : "null") + ',' +
