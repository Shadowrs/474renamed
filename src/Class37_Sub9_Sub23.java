...
public class Class37_Sub9_Sub23 extends Class37_Sub9 {
    ...
    public static JString aJString_3347;
    public static JString aJString_3348 = Class37_Sub2.method332((byte) 116,
            "Cancel");
    public static int anInt3349;
    public static JString aJString_3350 = Class37_Sub2.method332((byte) 121,
            "<)4col> x");
    ...
    public int[] method761(int i, int i_16_) {
        ...
        if (aClass38_1966.aBoolean850) {
            int[] is_17_ = this.method760((Class37_Sub4_Sub7_Sub1_Sub2.anInt3989 &
                    (-1 + i_16_)), 0, -61);
            ...
            for (int i_20_ = 0; i_20_ < Class32.anInt743; i_20_++) {
                ...
                int i_27_ = (int) (4096.0 * Math.sqrt((double) ((4096 +
                        (i_26_ + i_24_)) / 4096)));
