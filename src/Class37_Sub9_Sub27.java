...
public class Class37_Sub9_Sub27 extends Class37_Sub9 {
    ...
    public static Stream aStream_3399;
    public static int anInt3400 = 10;
    public static int[] anIntArray3401;
    public static JString aJString_3402;
    public static int anInt3403;
    public static JString aJString_3404;
    ...
    public static JString aJString_3411;
    public static int anInt3412;
    public static int anInt3413;
    public static JString aJString_3414;
    public static JString aJString_3415 = Class37_Sub2.method332((byte) 115,
            "sl_back");
    ...
    static {
        ...
        aJString_3402 = (Class37_Sub2.method332((byte) 127,
                "This computers address has been blocked"));
        aJString_3414 = Class37_Sub2.method332((byte) 120, "Use");
        aJString_3404 = aJString_3414;
        aJString_3411 = aJString_3402;
        anInt3418 = 0;
    }
    ...
    public int[][] method759(byte i, int i_0_) {
        ...
        if (aClass33_1946.aBoolean767) {
            int[][] is_1_ = this.method762(0,
                    aBoolean3416
                    ? ((Class37_Sub4_Sub7_Sub1_Sub2.anInt3989) - i_0_) : i_0_,
                    (byte) -92);
            int[] is_2_ = is_1_[2];
            int[] is_3_ = is[0];
            int[] is_4_ = is_1_[0];
    ...
    public static void method879(int i) {
        ...
        Class37_Sub4_Sub7_Sub2 class37_sub4_sub7_sub2 = ((Class37_Sub4_Sub7_Sub2) Class37_Sub9_Sub5.aClass58_2994.method1155(0));

        if (i == -1) {
            for (; class37_sub4_sub7_sub2 != null;
                    class37_sub4_sub7_sub2 = (Class37_Sub4_Sub7_Sub2) Class37_Sub9_Sub5.aClass58_2994.method1162(
                            (byte) 55)) {
                if (((Class37_Sub9_Sub1.anInt2916 ^ 0xffffffff) == (class37_sub4_sub7_sub2.anInt3723 ^
                        0xffffffff)) &&
                        (Class37_Sub7.anInt1898 <= class37_sub4_sub7_sub2.anInt3730)) {
                    if ((class37_sub4_sub7_sub2.anInt3713 ^ 0xffffffff) >= (Class37_Sub7.anInt1898 ^
                            0xffffffff)) {
                        if (class37_sub4_sub7_sub2.anInt3710 > 0) {
                            Class37_Sub4_Sub7_Sub1_Sub1 class37_sub4_sub7_sub1_sub1 =
                                (Class37_Sub13.aClass37_Sub4_Sub7_Sub1_Sub1Array2111[class37_sub4_sub7_sub2.anInt3710 +
                                -1]);
                            ...
                            if ((class37_sub4_sub7_sub1_sub1 != null) &&
                                    ...
                                    0xffffffff) <= -1) &&
                                    (class37_sub4_sub7_sub1_sub1.anInt3642 < 13312)) {
                                class37_sub4_sub7_sub2.method514(class37_sub4_sub7_sub1_sub1.anInt3666,
                        ...
                        if ((class37_sub4_sub7_sub2.anInt3710 ^ 0xffffffff) > -1) {
                            int i_10_ = -1 + -class37_sub4_sub7_sub2.anInt3710;
                            Class37_Sub4_Sub7_Sub1_Sub2 class37_sub4_sub7_sub1_sub2;

                            if ((Class37_Sub9_Sub5.anInt2998 ^ 0xffffffff) == (i_10_ ^
                                    0xffffffff)) {
                                class37_sub4_sub7_sub1_sub2 = (Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234);
                            } else {
                                class37_sub4_sub7_sub1_sub2 = (Class75.aClass37_Sub4_Sub7_Sub1_Sub2Array1414[i_10_]);
                            }
                            ...
                            if ((class37_sub4_sub7_sub1_sub2 != null) &&
                                    ...
                                    (class37_sub4_sub7_sub1_sub2.anInt3642 < 13312)) {
                                class37_sub4_sub7_sub2.method514(class37_sub4_sub7_sub1_sub2.anInt3666,
                                    Class37_Sub7.anInt1898, true,
                        ...
                        class37_sub4_sub7_sub2.method511(Class37_Sub9_Sub37.anInt3589,
                            -3317);
    ...
    public static void method880(int i) {
        ...
        if (Class37_Sub4_Sub6.aBoolean2613 &&
            ...
            Class37_Sub9_Sub22.method859((byte) -128,
                Class37_Sub4_Sub7.anInt2641, Class37_Sub10.anInt1985,
    ...
    public static JString method881(int i, JString[] jstrings) {
        int i_11_ = 125 % ((i - 66) / 39);
        anInt3412++;

        if ((jstrings.length ^ 0xffffffff) > -3) {
            throw new IllegalArgumentException();
        }

        return Class43.method1090(jstrings.length, 0, -95, jstrings);
    }
...
while_95_: 
    ...
    public int[] method761(int i, int i_13_) {
        ...
        if (aClass38_1966.aBoolean850) {
            int[] is_14_ = this.method760(((!aBoolean3416) ? i_13_
                                                           : (-i_13_ +
    ...
    public static JString method882(int i, boolean bool, int i_16_) {
        anInt3403++;
