...
public class Class29 {
    ...
    public static JString aJString_705 = Class37_Sub2.method332((byte) 113,
            "und Ihr Passwort ein)3");
    public static int anInt706;
    public static JString aJString_707;
    public static int anInt708;
    public static JString aJString_709 = Class37_Sub2.method332((byte) 117,
            "Try again in 60 secs)3)3)3");
    public static JString aJString_710 = aJString_709;
    public static Class15_Sub1 aClass15_Sub1_711;
    public static int anInt712;
    public static JString aJString_713;
    public static int anInt715;
    public static int anInt716;

    static {
        aJString_707 = Class37_Sub2.method332((byte) 106, "ams");
        aJString_713 = Class37_Sub2.method332((byte) 113, "leuchten3:");
    }
    ...
    public Class37_Sub4_Sub7_Sub4 method262(boolean bool) {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            if (((i_1_ ^ 0xffffffff) <= -513) &&
                    !Class46.method1108(i_1_ + -512, (byte) 79)
                                .method450(aBoolean700, 20274)) {
                bool_0_ = true;
            }
        }
        ...
        for (int i_2_ = 0; i_2_ < 12; i_2_++) {
            ...
            if (((i_3_ ^ 0xffffffff) <= -257) && ((i_3_ ^ 0xffffffff) > -513)) {
                Class37_Sub4_Sub7_Sub4 class37_sub4_sub7_sub4 = Class37_Sub9_Sub36.method918(8237,
                        -256 + i_3_).method479((byte) -103);
            ...
            if (i_3_ >= 512) {
                Class37_Sub4_Sub7_Sub4 class37_sub4_sub7_sub4 = Class46.method1108(-512 +
                        i_3_, (byte) 100).method448((byte) -119, aBoolean700);
        ...
        Class37_Sub4_Sub7_Sub4 class37_sub4_sub7_sub4 = new Class37_Sub4_Sub7_Sub4(class37_sub4_sub7_sub4s,
                i);

        for (int i_4_ = 0; i_4_ < 5; i_4_++) {
            if (Class37_Sub4_Sub7_Sub1.aShortArrayArray3702[i_4_].length > anIntArray697[i_4_]) {
                class37_sub4_sub7_sub4.method535((ItemDef.aShortArray2491[i_4_]),
                    (Class37_Sub4_Sub7_Sub1.aShortArrayArray3702[i_4_][anIntArray697[i_4_]]));
            }

            if ((anIntArray697[i_4_] ^ 0xffffffff) > (Class37_Sub17.aShortArrayArray2159[i_4_].length ^
                    0xffffffff)) {
                class37_sub4_sub7_sub4.method535(Login.aShortArray789[i_4_],
            ...
            for (;;) {
                if (!bool_13_) {
                    ...
                    if ((i_16_ > 0) && ((i_19_ ^ 0xffffffff) < -1) &&
                        ...
                        ObjectDef objectdef = Class37_Sub9_Sub8.method794(i_10_,
                                28067);

                        if ((i_17_ != 22) || !Class37_Sub4_Sub6.aBoolean2613 ||
                                ((objectdef.anInt2726 ^ 0xffffffff) != -1) ||
                                ((objectdef.anInt2740 ^ 0xffffffff) == -2) ||
                                objectdef.aBoolean2728) {
                            bool_13_ = true;

                            if (!objectdef.method692(74)) {
                                bool = false;
                                Class76.anInt1437++;
                            }
                        }
    ...
    public int method268(int i) {
        ...
        if (anInt696 == -1) {
            ...
            (anIntArray697[0] << -1180927719) +
            (anIntArray702[0] << -1847093137))) -
            (-(anIntArray702[11] << 1107408485) - anIntArray702[1]));
        }

        return (305419896 +
        Class37_Sub9_Sub34.method912(56, anInt696).anInt2842);
    }
        ...
        try {
            ...
            if (is == null) {
                ...
                for (int i_32_ = 0; i_32_ < 7; i_32_++) {
                    for (int i_33_ = 0; Class37_Sub2.anInt1832 > i_33_;
                            i_33_++) {
                        Class37_Sub4_Sub4 class37_sub4_sub4 = Class37_Sub9_Sub36.method918(8237,
                                i_33_);

                        if ((class37_sub4_sub4 != null) &&
                                !class37_sub4_sub4.aBoolean2570 &&
                                (class37_sub4_sub4.anInt2584 == ((bool ? 7 : 0) +
                                i_32_))) {
            ...
            if ((i_35_ != 0) && (i < -38)) {
                ...
                do {
                    if (bool) {
                        ...
                        if ((Class37_Sub2.anInt1832 ^ 0xffffffff) >= (i_35_ ^
                                0xffffffff)) {
                            i_35_ = 0;
                        }
                    } else if (--i_35_ < 0) {
                    ...
                    class37_sub4_sub4 = Class37_Sub9_Sub36.method918(8237, i_35_);
    ...
    public Class37_Sub4_Sub7_Sub6 method272(
        ...
        try {
            ...
            if ((anInt696 ^ 0xffffffff) != 0) {
                return (Class37_Sub9_Sub34.method912(-78, anInt696)
                                          .method715(class37_sub4_sub12_38_,
                    class37_sub4_sub12, i_37_, i, (byte) 114));
            }
            ...
            if ((class37_sub4_sub12 != null) &&
                    ((class37_sub4_sub12.anInt2769 >= 0) ||
                    (class37_sub4_sub12.anInt2758 >= 0))) {
                is = new int[12];
                ...
                if ((class37_sub4_sub12.anInt2769 ^ 0xffffffff) <= -1) {
                    l += (long) ((-anIntArray702[5] +
                    class37_sub4_sub12.anInt2769) << 1987488712);
                    is[5] = class37_sub4_sub12.anInt2769;
                }

                if ((class37_sub4_sub12.anInt2758 ^ 0xffffffff) <= -1) {
                    l += (long) ((-anIntArray702[3] +
                    class37_sub4_sub12.anInt2758) << 259414192);
                    is[3] = class37_sub4_sub12.anInt2758;
                }
            }

            Class37_Sub4_Sub7_Sub6 class37_sub4_sub7_sub6 = ((Class37_Sub4_Sub7_Sub6) Class32_Sub1.aClass65_1780.method1181((byte) 97,
                    l));
            ...
            if (class37_sub4_sub7_sub6 == null) {
                ...
                for (int i_40_ = 0; i_40_ < 12; i_40_++) {
                    ...
                    if (((i_41_ ^ 0xffffffff) <= -257) && (i_41_ < 512) &&
                            !Class37_Sub9_Sub36.method918(8237, -256 + i_41_)
                                                   .method477((byte) 4)) {
                        bool = true;
                    }

                    if ((i_41_ >= 512) &&
                            !Class46.method1108(i_41_ - 512, (byte) 113)
                ...
                if (bool) {
                    if ((aLong714 ^ 0xffffffffffffffffL) != 0L) {
                        class37_sub4_sub7_sub6 = ((Class37_Sub4_Sub7_Sub6) Class32_Sub1.aClass65_1780.method1181((byte) 96,
                                aLong714));
                    }
                ...
                if (class37_sub4_sub7_sub6 == null) {
                    ...
                    for (int i_45_ = 0; i_45_ < 5; i_45_++) {
                        if (anIntArray697[i_45_] < (Class37_Sub4_Sub7_Sub1.aShortArrayArray3702[i_45_]).length) {
                            class37_sub4_sub7_sub4.method535(ItemDef.aShortArray2491[i_45_],
            ...
            if ((class37_sub4_sub12 != null) ||
                ...
                if ((class37_sub4_sub12 == null) ||
                        (class37_sub4_sub12_38_ == null)) {
                    if (class37_sub4_sub12 != null) {
                        class37_sub4_sub7_sub6_46_ = (class37_sub4_sub12.method704(class37_sub4_sub7_sub6,
                                i_37_, 65535));
                    } else {
                        class37_sub4_sub7_sub6_46_ = class37_sub4_sub12_38_.method704(class37_sub4_sub7_sub6,
                                i, 65535);
                    }
                } else {
                    class37_sub4_sub7_sub6_46_ = class37_sub4_sub12.method701(i_37_,
                            class37_sub4_sub7_sub6, (byte) -77,
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("ia.D(" + ((class37_sub4_sub12 != null) ? "{...}" : "null") +
                ',' + i + ',' + i_36_ + ',' + i_37_ + ',' +
                ((class37_sub4_sub12_38_ != null) ? "{...}" : "null") + ')'));
        }
    }
}
