...
public abstract class Class15 {
    ...
    public void method109(byte[] is, int i) {
        ...
        Stream stream = new Stream(Login.method312(is,
                    (byte) 106));
        anInt289++;
        ...
        if (i == 29725) {
            ...
            if (i_2_ != 0) {
                ...
                for (int i_6_ = 0;
                        (i_6_ ^ 0xffffffff) > ((1 + i_4_) ^ 0xffffffff);
                        i_6_++)
            ...
            if ((i_2_ ^ 0xffffffff) != -1) {
                ...
                for (int i_17_ = 0;
                        (anInt254 ^ 0xffffffff) < (i_17_ ^ 0xffffffff);
                        i_17_++) {
                    ...
                    for (int i_20_ = 0;
                            anObjectArrayArray253[i_18_].length > i_20_;
                            i_20_++)
    ...
    public byte[] method110(int i, int i_22_, int i_23_) {
        ...
        if ((i_23_ < 0) ||
                ((anObjectArrayArray253.length ^ 0xffffffff) >= (i_23_ ^
                0xffffffff)) || (anObjectArrayArray253[i_23_] == null) ||
                (i < 0) ||
                ((i ^ 0xffffffff) <= (anObjectArrayArray253[i_23_].length ^
                0xffffffff))) {
            return null;
        }
    ...
    public byte[] method113(int i, int i_26_, int i_27_, int[] is) {
        ...
        if ((i_27_ < 0) ||
                ((anObjectArrayArray253.length ^ 0xffffffff) >= (i_27_ ^
                0xffffffff)) || (anObjectArrayArray253[i_27_] == null) ||
                ((i_26_ ^ 0xffffffff) > -1) ||
...
//dekoduojama (sukuriama jei netureta) is gzip su Inflate bla bla
    ...
    public boolean method115(int i, int i_32_, int i_33_) {
        ...
        if ((i_32_ < 0) ||
                ((i_32_ ^ 0xffffffff) <= (anObjectArrayArray253.length ^
                0xffffffff)) || (anObjectArrayArray253[i_32_] == null) ||
                ((i_33_ ^ 0xffffffff) > -1) ||
                ((i_33_ ^ 0xffffffff) <= (anObjectArrayArray253[i_32_].length ^
                0xffffffff))) {
            return false;
        }
    ...
    public static void method116(int i) {
        ...
        if (!Class24.aBoolean609 || !Class32.aBoolean746) {
            ...
            if (i == 0) {
                ...
                if ((Class37_Sub4_Sub7_Sub1_Sub2.anInt3977 ^ 0xffffffff) < (i_34_ ^
                        0xffffffff)) {
                ...
                if ((Class77.aClass18_1452.anInt441 +
                        Class37_Sub4_Sub7_Sub1_Sub2.anInt3977) < (i_34_ -
                        -Class37_Sub7.aClass18_1894.anInt441)) {
                    i_34_ = (Class77.aClass18_1452.anInt441 +
                ...
                if ((Class37_Sub7.aClass18_1894.anInt353 + i_35_) > (Class59.anInt1134 +
                    ...
                    i_35_ = (Class59.anInt1134 -
                        -Class77.aClass18_1452.anInt353 -
                        Class37_Sub7.aClass18_1894.anInt353);
                }

                int i_38_ = i_35_ + -RuntimeException_Sub1.anInt1626;

                if (((Class37_Sub4_Sub7.anInt2640 ^ 0xffffffff) < (Class37_Sub7.aClass18_1894.anInt350 ^
                        0xffffffff)) &&
                        ((i_37_ > i_36_) ||
                ...
                int i_39_ = ((-Class59.anInt1134 + i_35_) -
                    -Class77.aClass18_1452.anInt432);
                int i_40_ = (-Class37_Sub4_Sub7_Sub1_Sub2.anInt3977 + i_34_ +
                    Class77.aClass18_1452.anInt371);
                ...
                if ((Class60.anInt1140 ^ 0xffffffff) == -1) {
                    if (Class37_Sub9_Sub37.aBoolean3591) {
                        ...
                        Class37_Sub5.method738((byte) -122,
        ...
        if (((Class25.anInt637 ^ 0xffffffff) <= -51) || bool) {
            ...
            do {
                if (!Class37_Sub18.aBoolean2201 &&
                    ...
                    try {
                        Applet_Sub1.activeSocket.write(0, (byte) 116,
    ...
    public byte[] method126(byte i, JString jstring, JString jstring_51_) {
        try {
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("dd.CA(" + i + ',' + ((jstring != null) ? "{...}" : "null") +
                ',' + ((jstring_51_ != null) ? "{...}" : "null") + ')'));
        }
    }
    ...
    public void method127(boolean bool) {
        ...
        for (int i = 0; anObjectArrayArray253.length > i; i++) {
            if (anObjectArrayArray253[i] != null) {
                for (int i_55_ = 0; i_55_ < anObjectArrayArray253[i].length;
                        i_55_++)
    ...
    public boolean method130(JString jstring, JString jstring_58_, int i) {
        try {
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("dd.K(" + ((jstring != null) ? "{...}" : "null") + ',' +
                ((jstring_58_ != null) ? "{...}" : "null") + ',' + i + ')'));
        }
    }
...
//cia dekoduojamas mapas, mapo info.
            ...
            throw Class37_Sub4_Sub7_Sub3.method516(runtimeexception,
                ("T3 - " + (is != null) + "," + i_63_ + "," + is_67_.length +
