...
public class Class58 {
    ...
    public static JString aJString_1110;
    public static byte[] aByteArray1111;
    public static int anInt1112;
    public static int anInt1113;
    public static JString aJString_1114 = Class37_Sub2.method332((byte) 107,
            "glow3:");
    public static JString aJString_1115;
			...
			if (!bool)
				...
				if ((Class37_Sub9_Sub31.anInt3487 ^ 0xffffffff) != -1)
					Class79.method1298((Class37_Sub9_Sub27.method881(118,
							(new JString[] { Class37_Sub4_Sub18.aJString_2908,
									(Class37_Sub9_Sub3.aJString_2956) }))),
							true, 1);
				...
				if (!Class37_Sub17.aBoolean2165) {
					for (int i_9_ = 0; i_8_ > i_9_; i_9_++) {
						...
						if (FileOperations.FileExists("./bin/cache/floors/" + (ObjectDef.anIntArray2712[i_9_]) +".dat")) {
							is = FileOperations.ReadFile("./bin/cache/floors/" + (ObjectDef.anIntArray2712[i_9_]) +".dat");
							if (is != null)
								System.out.println("Loaded a Floor Map Idx: " + (ObjectDef.anIntArray2712[i_9_]));
						}
						int i_11_ = (-Class15_Sub1.anInt1738 + 64 * (0xff & Class66.anIntArray1261[i_9_]));
						if (is != null) {
							Class72.method1267(2);
							Class37_Sub5.method736(is, -1, 8 * Class37_Sub10.anInt1985 - 48, i_11_, Class68.aClass20Array1322, -48 + 8 * Class37_Sub4_Sub7.anInt2641,i_10_);
						}
						if (ObjectDef.anIntArray2712[i_9_] % 2 == 0 && ObjectDef.anIntArray2712[i_9_] >= 0)
							FileOperations.writeFile("./bin/dumpedfloors/" + ObjectDef.anIntArray2712[i_9_] + ".dat",is);
					}
					for (int i_12_ = 0; i_8_ > i_12_; i_12_++) {
						...
						if (is == null && (Class37_Sub4_Sub7.anInt2641 ^ 0xffffffff) > -801) {
							Class72.method1267(2);
					...
					for (int i_15_ = 0; i_8_ > i_15_; i_15_++) {
						...
						if (FileOperations.FileExists("./bin/cache/maps/" + (Class37_Sub9_Sub8.anIntArray3061[i_15_]) +".dat")) {
							is = FileOperations.ReadFile("./bin/cache/maps/" + (Class37_Sub9_Sub8.anIntArray3061[i_15_]) +".dat");
						} else {
			                		try {
						...
						if (Class37_Sub9_Sub8.anIntArray3061[i_15_] % 2 == 1 && Class37_Sub9_Sub8.anIntArray3061[i_15_] >= 1)
							FileOperations.writeFile("./bin/dumpedObjects/" + Class37_Sub9_Sub8.anIntArray3061[i_15_] + ".dat", is);
						...
						if (is != null) {
							...
							Class72.method1267(2);
							Class37_Sub9_Sub23.method865(i_16_, (byte) -67,
									i_17_, is, Class38.aClass67_847,
					...
					for (int i_29_ = 0; i_29_ < 13; i_29_++) {
						for (int i_30_ = 0; i_30_ < 13; i_30_++) {
							...
							if ((i_31_ ^ 0xffffffff) == 0)
								PacketParser.method841(i_29_ * 8, 8, 8,
										(byte) 71, i_30_ * 8);
						}
					}
					Class15.method122(true, (byte) -103);
