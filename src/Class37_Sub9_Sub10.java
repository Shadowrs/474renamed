    ...
    public void method750(Stream stream, int i, boolean bool) {
        ...
        do {
            if ((i_0_ ^ 0xffffffff) != -1) {
                ...
                anInt3092 = stream.method980(116) << 468966756;

                break;
            }

            aBoolean1943 = (stream.method978(118) ^ 0xffffffff) == -2;
        } while (false);
    ...
    public static void method803(int i, int i_1_, int i_2_) {
        ...
        if ((Class37_Sub14.anInt2121 ^ 0xffffffff) != (i ^ 0xffffffff)) {
            ...
            for (int i_4_ = 0; (i ^ 0xffffffff) < (i_4_ ^ 0xffffffff);
                    i_4_++)
                Class37_Sub4_Sub16.anIntArray2871[i_4_] = (i_4_ << -124742836) / i;
        ...
        if (((i_5_ ^ 0xffffffff) != 0) || Class55.aBoolean1071) {
            if (((i_5_ ^ 0xffffffff) != 0) &&
                ...
                Class37_Sub4_Sub4.method476(2, Class54.aClass15_Sub1_1060,
                    i_5_, Class37_Sub9_Sub17.anInt3223, false, true, 0);
            }
        } else {
    ...
    public int[] method761(int i, int i_6_) {
        ...
        if (aClass38_1966.aBoolean850) {
            ...
            for (int i_9_ = 0; Class32.anInt743 > i_9_; i_9_++) {
                ...
                int i_13_ = ((i_11_ * Class37_Sub4_Sub7_Sub2.anIntArray3711[i_10_]) >> -1559384596);
                int i_14_ = Applet_Sub1.anInt12 &
                    (i_9_ - -(i_13_ >> -146964724));
    ...
    public int[][] method759(byte i, int i_17_) {
        ...
        if (aClass33_1946.aBoolean767) {
            ...
            for (int i_23_ = 0; i_23_ < Class32.anInt743; i_23_++) {
                ...
                int i_28_ = (i_23_ - -(i_26_ >> -1481110164)) &
                    Applet_Sub1.anInt12;
