...
public abstract class Class37_Sub4_Sub7_Sub1 extends Class37_Sub4_Sub7 {
    ...
    public static JString aJString_3649 = Class37_Sub2.method332((byte) 125,
            ":chalreq:");
    ...
    public void method495(boolean bool, int i, int i_0_) {
        ...
        if (((anInt3655 ^ 0xffffffff) != 0) &&
                ((Class37_Sub9_Sub22.method861(i ^ ~0xdbe, anInt3655).anInt2754 ^
                0xffffffff) == -2)) {
            anInt3655 = -1;
        }
    ...
    public static void method498(boolean bool) {
        while (Class83.packetStream.method991(
            ...
            if (Class75.aClass37_Sub4_Sub7_Sub1_Sub2Array1414[i] == null) {
                ...
                if (Class37_Sub9_Sub15.aStreamArray3175[i] != null) {
                    Class75.aClass37_Sub4_Sub7_Sub1_Sub2Array1414[i].method509(Class37_Sub9_Sub15.aStreamArray3175[i],
                        65535);
                }
            }
            ...
            class37_sub4_sub7_sub1_sub2.method499((Class37_Sub23.aClass37_Sub4_Sub7_Sub1_Sub2_2234.anIntArray3669[0]) -
                -i_14_,
                i_12_ +
