...
public class Class37_Sub24 extends Class37 {
    ...
    public float[] method1035(int i) {
        ...
        if (bool_17_) {
            ...
            for (int i_35_ = 0; i_35_ < i_25_; i_35_++) {
                ...
                fs[(4 * i_35_) + 3] = ((f - f_37_) * f_39_) -
                    ((f_36_ - f_38_) * f_40_);

                fs[(4 * i_35_) + 1] = ((f_36_ - f_38_) * f_39_) +
                    ((f - f_37_) * f_40_);
            }
            ...
            for (int i_42_ = 0; i_42_ < (i_41_ - 3); i_42_++) {
                ...
                for (int i_45_ = 0; i_45_ < (2 << i_42_); i_45_++) {
                    ...
                    for (int i_48_ = 0; i_48_ < (i_5_ >> (i_42_ + 4));
                            i_48_++) {
                        int i_49_ = 4 * i_48_;
            ...
            for (int i_68_ = 0; i_68_ < i_24_; i_68_++) {
                fs[i_68_] = ((fs[(2 * i_68_) + i_23_] * fs_29_[2 * i_68_]) +
                    (fs[(2 * i_68_) + 1 + i_23_] * fs_29_[(2 * i_68_) + 1]));

                fs[i_23_ - 1 - i_68_] = ((fs[(2 * i_68_) + i_23_] * fs_29_[(2 * i_68_) +
                    1]) - (fs[(2 * i_68_) + 1 + i_23_] * fs_29_[2 * i_68_]));
            }
            ...
            for (int i_73_ = i_9_; i_73_ < i_10_; i_73_++) {
                float f = (float) Math.sin(((double) (i_73_ - i_9_) + 0.5) / (double) i_11_ * 0.5 * 3.141592653589793);

                aFloatArray2245[i_73_] *= (float) Math.sin(1.5707963267948966 * (double) f * (double) f);
            }

            for (int i_74_ = i_12_; i_74_ < i_13_; i_74_++) {
                float f = (float) Math.sin((((double) (i_74_ - i_12_) + 0.5) / (double) i_14_ * 0.5 * 3.141592653589793) +
                        1.5707963267948966);

                aFloatArray2245[i_74_] *= (float) Math.sin(1.5707963267948966 * (double) f * (double) f);
            }
        }
    ...
    public void method1038(byte[] is) {
        ...
        for (int i_85_ = 0; i_85_ < i; i_85_++) {
            ...
            do {
                i_87_ = stream.method978(121);
                i_86_ += i_87_;
            } while (i_87_ >= 255);

            byte[] is_88_ = new byte[i_86_];
            stream.method968(0, i_86_, is_88_, (byte) -53);
    ...
    public static void method1040(byte[] is) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            for (int i_93_ = 0; i_93_ < i_91_; i_93_++) {
                fs[2 * i_93_] = (float) Math.cos(((double) (4 * i_93_) * 3.141592653589793) / (double) i_89_);

                fs[(2 * i_93_) + 1] = -(float) Math.sin(((double) (4 * i_93_) * 3.141592653589793) / (double) i_89_);
            }

            float[] fs_94_ = new float[i_90_];

            for (int i_95_ = 0; i_95_ < i_91_; i_95_++) {
                fs_94_[2 * i_95_] = (float) Math.cos(((double) ((2 * i_95_) +
                        1) * 3.141592653589793) / (double) (2 * i_89_));

                fs_94_[(2 * i_95_) + 1] = (float) Math.sin(((double) ((2 * i_95_) +
                        1) * 3.141592653589793) / (double) (2 * i_89_));
            }
            ...
            for (int i_97_ = 0; i_97_ < i_92_; i_97_++) {
                fs_96_[2 * i_97_] = (float) Math.cos(((double) ((4 * i_97_) +
                        2) * 3.141592653589793) / (double) i_89_);

                fs_96_[(2 * i_97_) + 1] = -(float) Math.sin(((double) ((4 * i_97_) +
                        2) * 3.141592653589793) / (double) i_89_);
            }
            ...
            for (int i_100_ = 0; i_100_ < i_92_; i_100_++)
                is_98_[i_100_] = Class37_Sub9_Sub26.method875(i_100_,
                        (byte) 85, i_99_);
    ...
    public static int method1041(int i) {
        ...
        for (; i >= (8 - anInt2270); i -= i_114_) {
            ...
            i_112_ += (((aByteArray2262[anInt2251] >> anInt2270) & i_115_) << i_113_);
            anInt2270 = 0;
            anInt2251++;
            i_113_ += i_114_;
        }
        ...
        if (i > 0) {
            ...
            i_112_ += (((aByteArray2262[anInt2251] >> anInt2270) & i_114_) << i_113_);
            anInt2270 += i;
        }
